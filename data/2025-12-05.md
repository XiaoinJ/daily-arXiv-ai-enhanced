...
### [1] [Probabilistic Safety under Arbitrary Disturbance Distributions using Piecewise-Affine Control Barrier Functions](https://arxiv.org/abs/2512.04194)
...
### [2] [Undiscounted Equilibrium in Positive Recursive Absorbing Games with Non-Rectangular Absorption Structure](https://arxiv.org/abs/2512.04306)
...
### [3] [A Dual Riemannian ADMM Algorithm for Low-Rank SDPs with Unit Diagonal](https://arxiv.org/abs/2512.04406)
...
### [4] [An accelerated proximal bundle method for convex optimization](https://arxiv.org/abs/2512.04523)
...
### [5] [Research on the descent direction of prediction correction algorithms for pseudo-convex/convex optimization problems](https://arxiv.org/abs/2512.04575)
...
### [6] [Temporal and Spatial Decomposition for Prospective Studies in Energy Systems under Uncertainty](https://arxiv.org/abs/2512.04622)
...
### [7] [The $Λ$-Set and Its Role in Local Controllability and Necessary Conditions for Free-Time Optimal Control](https://arxiv.org/abs/2512.04651)
*Mohammad H. M. Rashid*
...
### [8] [Continuous-time reinforcement learning for optimal switching over multiple regimes](https://arxiv.org/abs/2512.04697)
...
### [9] [Coordinated Mean-Field Control for Systemic Risk](https://arxiv.org/abs/2512.04704)
*Toshiaki Yamanaka*
...
### [10] [Neural Policy Composition from Free Energy Minimization](https://arxiv.org/abs/2512.04745)
...
### [11] [Adaptive Online Optimization for Microgrids with Renewable Energy Sources](https://arxiv.org/abs/2512.04778)
...
### [12] [CRAFT-E: A Neuro-Symbolic Framework for Embodied Affordance Grounding](https://arxiv.org/abs/2512.04231)
...
### [13] [Sliding Mode Control and Subspace Stabilization Methodology for the Orbital Stabilization of Periodic Trajectories](https://arxiv.org/abs/2512.04249)
...
### [14] [Driving Beyond Privilege: Distilling Dense-Reward Knowledge into Sparse-Reward Policies](https://arxiv.org/abs/2512.04279)
...
### [15] [ResponsibleRobotBench: Benchmarking Responsible Robot Manipulation using Multi-modal Large Language Models](https://arxiv.org/abs/2512.04308)
...
### [16] [Vertical Planetary Landing on Sloped Terrain Using Optical Flow Divergence Estimates](https://arxiv.org/abs/2512.04373)
...
### [17] [FALCON: Actively Decoupled Visuomotor Policies for Loco-Manipulation with Foundation-Model-Based Coordination](https://arxiv.org/abs/2512.04381)
...
### [18] [Development of a 15-Degree-of-Freedom Bionic Hand with Cable-Driven Transmission and Distributed Actuation](https://arxiv.org/abs/2512.04399)
...
### [19] [RoboBPP: Benchmarking Robotic Online Bin Packing with Physics-based Simulation](https://arxiv.org/abs/2512.04415)
...
### [20] [Vision-Language-Action Models for Selective Robotic Disassembly: A Case Study on Critical Component Extraction from Desktops](https://arxiv.org/abs/2512.04446)
...
### [21] [Open-Ended Goal Inference through Actions and Language for Human-Robot Collaboration](https://arxiv.org/abs/2512.04453)
...
### [22] [One Ring to Rule Them All: Constrained Distributional Control for Massive-Scale Heterogeneous Robotic Ensemble Systems](https://arxiv.org/abs/2512.04502)
...
### [23] [Bridging Simulation and Reality: Cross-Domain Transfer with Semantic 2D Gaussian Splatting](https://arxiv.org/abs/2512.04731)
...
### [24] [Embodied Co-Design for Rapidly Evolving Agents: Taxonomy, Frontiers, and Challenges](https://arxiv.org/abs/2512.04770)
...
### [25] [TEMPO-VINE: A Multi-Temporal Sensor Fusion Dataset for Localization and Mapping in Vineyards](https://arxiv.org/abs/2512.04772)
...
### [26] [Using Machine Learning to Take Stay-or-Go Decisions in Data-driven Drone Missions](https://arxiv.org/abs/2512.04773)
...
### [27] [MOVE: A Simple Motion-Based Data Collection Paradigm for Spatial Generalization in Robotic Manipulation](https://arxiv.org/abs/2512.04813)
...
### [28] [Hoi! - A Multimodal Dataset for Force-Grounded, Cross-View Articulated Manipulation](https://arxiv.org/abs/2512.04884)
...
### [29] [On Disturbance-Aware Minimum-Time Trajectory Planning: Evidence from Tests on a Dynamic Driving Simulator](https://arxiv.org/abs/2512.04917)
...
### [30] [Hybrid-Diffusion Models: Combining Open-loop Routines with Visuomotor Diffusion Policies](https://arxiv.org/abs/2512.04960)
...
### [31] [Preliminary Analysis and Simulation of a Compact Variable Stiffness Wrist](https://arxiv.org/abs/2512.04973)
...
### [32] [Introducing V-Soft Pro: a Modular Platform for a Transhumeral Prosthesis with Controllable Stiffness](https://arxiv.org/abs/2512.04998)
...
### [33] [Contact-Implicit Modeling and Simulation of a Snake Robot on Compliant and Granular Terrain](https://arxiv.org/abs/2512.05008)
*Haroon Hublikar*
...
### [34] [From Generated Human Videos to Physically Plausible Robot Trajectories](https://arxiv.org/abs/2512.05094)
...
### [35] [STARE-VLA: Progressive Stage-Aware Reinforcement for Fine-Tuning Vision-Language-Action Models](https://arxiv.org/abs/2512.05107)
...
### [36] [Symmetry-enforced Fermi surfaces](https://arxiv.org/abs/2512.04150)
...
### [37] [Deformed LDPC codes with spontaneously broken non-invertible duality symmetries](https://arxiv.org/abs/2512.04174)
...
### [38] [2D Helical Twist Controls Tricritical Point in an Interacting Majorana Chain](https://arxiv.org/abs/2512.04180)
...
### [39] [Magnetocaloric effect measurements in ultrahigh magnetic fields up to 120 T](https://arxiv.org/abs/2512.04509)
...
### [40] [Phase transitions on the dark side of the Gross-Neveu model](https://arxiv.org/abs/2512.04626)
...
### [41] [Anomalous impurity-induced charge modulations in black phosphorus](https://arxiv.org/abs/2512.04791)
...
### [42] [Tracing the horizon of tetragonal-to-monoclinic distortion in pressurized trilayer nickelate La4Ni3O10](https://arxiv.org/abs/2512.04975)
...
### [43] [Iterative Contact-resolving Hybrid Methods for Multiscale Contact Mechanics](https://arxiv.org/abs/2512.04411)
...
### [44] [Stable self-adaptive timestepping for Reduced Order Models for incompressible flows](https://arxiv.org/abs/2512.04592)
...
### [45] [Interface layers and coupling conditions for discrete kinetic models on networks: a spectral approac](https://arxiv.org/abs/2512.04634)
...
### [46] [Weighted total variation regularization for inverse problems with significant null spaces](https://arxiv.org/abs/2512.04729)
...
### [47] [Recent advances in the numerical solution of multi-order fractional differential equations](https://arxiv.org/abs/2512.04737)
...
### [48] [Construction of the Nearest Nonnegative Hankel Matrix for a Prescribed Eigenpair](https://arxiv.org/abs/2512.04812)
...
### [49] [Hierarchical matrix approximability of inverse of convection dominated finite element matrices](https://arxiv.org/abs/2512.04824)
...
### [50] [A High-Order Discretization Scheme for Surface Integral Equations for Analyzing the Electroencephalography Forward Problem](https://arxiv.org/abs/2512.04845)
...
### [51] [Data-driven Methods for Delay Differential Equations](https://arxiv.org/abs/2512.04894)
...
### [52] [Weak convergence rates for spectral regularization via sampling inequalities](https://arxiv.org/abs/2512.04929)
...
### [53] [A tangential low-rank ADI method for solving indefinite Lyapunov equations](https://arxiv.org/abs/2512.04983)
...
### [54] [On the classicality theorem and its applications to the automorphy lifting theorem and the Breuil-M$\mathrm{\acute{e}}$zard conjecture in some $\mathrm{GL}_2(\mathbb{Q}_{p^2})$ cases](https://arxiv.org/abs/2512.04641)
*Kojiro Matsumoto*
...
### [55] [A Perfect Number Generalization and Some Euclid-Euler Type Results](https://arxiv.org/abs/2512.04417)
*Tyler Ross*
...
### [56] [On special values of meromorphic Drinfeld modular forms of arbitrary rank at CM points](https://arxiv.org/abs/2512.04490)
...
### [57] [Generalized discrete Markov spectra](https://arxiv.org/abs/2512.04547)
*Yasuaki Gyoda*
...
### [58] [Potential Automorphy of K3 Surfaces with Large Picard Rank](https://arxiv.org/abs/2512.04732)
*Chao Gu*
...
### [59] [Combinatorial proof of a result on generalized overcubic partitions and related conjectures](https://arxiv.org/abs/2512.04775)
...
### [60] [Existentially defining valuations in function fields over large fields](https://arxiv.org/abs/2512.04896)
*Nicolas Daans*
...
### [61] [More on the sum-product problem for integers with few prime factors](https://arxiv.org/abs/2512.04931)
*Thomas F. Bloom*
...
### [62] [A survey on the generalized Fermat equation of various signatures over totally real fields](https://arxiv.org/abs/2512.04936)
*Satyabrat Sahoo*
...
### [63] [Inertial Types of Elliptic Curves Over $\mathbb{Q}_{p^{2}}$](https://arxiv.org/abs/2512.05023)
...
### [64] [On the Outer Automorphism Groups of the Absolute Galois Groups of 2-adic local Fields](https://arxiv.org/abs/2512.05095)
*Yu Nishio*
...
### [65] [Decentralized Social Media and Artificial Intelligence in Digital Public Health Monitoring](https://arxiv.org/abs/2512.04232)
...
### [66] [Sedimentary models of fossil biomolecules, principles and methodological improvements](https://arxiv.org/abs/2512.04427)
...
### [69] [Yangians and degenerate affine Schur algebras](https://arxiv.org/abs/2512.04253)
...
### [70] [Dimension statistics of representations of finite groups](https://arxiv.org/abs/2512.05004)
...
### [71] [Clustering country-level all-cause mortality data: a review](https://arxiv.org/abs/2512.04831)
...
### [72] [Fisher information, Crámer-Rao complexity and temperature in logistic map](https://arxiv.org/abs/2512.04202)
...
### [74] [Edge Hamiltonian for Free Fermion Quantum Hall Models](https://arxiv.org/abs/2512.04430)
...
### [75] [Rotation angles of a rotating disc as the holonomy of the Hopf fibration](https://arxiv.org/abs/2512.04481)
*Takuya Matsumoto*
...
### [76] [On the weak solutions to the navier-Stokes equations: a possible gap related to the energy equality](https://arxiv.org/abs/2512.04654)
*Paolo Maremonti*
...
### [77] [A quantitative Hohenberg-Kohn theorem and the unexpected regularity of density functional theory in one spatial dimension](https://arxiv.org/abs/2512.04726)
...
### [78] [The swap transpose on couplings translates to Petz' recovery map on quantum channels](https://arxiv.org/abs/2512.04919)
...
### [79] [Cumulant expansions of operator groups of quantum many-particle systems](https://arxiv.org/abs/2512.05036)
...
### [80] [Search for the $Y(2175)$ in the photoproduction cross section measurement of $γp \to φπ^{+} π^{-} p$ at GlueX](https://arxiv.org/abs/2512.04136)
*GlueX Collaboration*
...
### [82] [Measurement of the branching fractions and longitudinal polarisations of $B^0_{(s)} \to K^{*0} \kern 0.18em \overline{\kern -0.18em K}{}^{*0}$ decays](https://arxiv.org/abs/2512.05102)
...
### [83] [The dispersion in pulsar $γ$-ray efficiency](https://arxiv.org/abs/2512.04181)
...
### [84] [Asymptotic constraints for 1D planar grey photon diffusion from linear transport with special-relativistic effects](https://arxiv.org/abs/2512.04342)
...
### [85] [Solar Cycle Variation of Sustained Gamma Ray Emission from the Sun](https://arxiv.org/abs/2512.04360)
...
### [86] [Mini-supernovae from white dwarf-neutron star mergers: Viewing-angle-dependent spectra and lightcurves](https://arxiv.org/abs/2512.04378)
...
### [87] [Unveiling gravitational waves from core-collapse supernovae with MUSE](https://arxiv.org/abs/2512.04804)
...
### [88] [Probing TeV Afterglow Emission of GRB~221009A with Gaussian Structured jet in Wind-driven medium](https://arxiv.org/abs/2512.04893)
...
### [89] [MALLORN: Many Artificial LSST Lightcurves based on Observations of Real Nuclear transients](https://arxiv.org/abs/2512.04946)
...
### [90] [Intertwined birth and death: a Herbig-Haro outflow resolves the distance to Vela Junior](https://arxiv.org/abs/2512.04956)
...
### [91] [Internal superfluid response and torque evolution in the giant glitch of PSR J1718-3718](https://arxiv.org/abs/2512.04972)
...
### [92] [Spectrum and anisotropies of Galactic cosmic rays: a laboratory for magnetic fields](https://arxiv.org/abs/2512.05035)
*Philipp Mertsch*
...
### [93] [PSR J0952-0607: Tightening a Record-High Neutron Star Mass](https://arxiv.org/abs/2512.05099)
