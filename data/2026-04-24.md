...
### [8] [Enhanced Reconstruction of Sub-GeV Neutrinos Charged Current Interactions in LArTPC](https://arxiv.org/abs/2604.20957)
...
### [9] [Search for dark matter produced in association with a dark Higgs boson decaying into a bottom quark-antiquark pair in proton-proton collisions at $\sqrt{s}$ = 13 TeV](https://arxiv.org/abs/2604.20999)
*CMS Collaboration*
...
### [10] [Performance of the LHCb muon detector in Run 3](https://arxiv.org/abs/2604.21075)
...
### [11] [Observation of a new excited charm-strange meson $D_{s1}(2933)^+$ in $B^0\to D^+ D^- K^+ π^-$ decays](https://arxiv.org/abs/2604.21257)
...
### [12] [Precision measurement of positron decay modes of Xe-125 in the LUX-ZEPLIN experiment](https://arxiv.org/abs/2604.21503)
...
### [13] [Effective field theory interpretation of ATLAS measurements involving the Higgs boson, electroweak bosons and the top quark](https://arxiv.org/abs/2604.21670)
*ATLAS Collaboration*
...
### [26] [Integrating opportunities and parametrized signatures for improved mutational processes estimation in extended sequence contexts](https://arxiv.org/abs/2604.21662)
...
### [27] [The geometry of conflict : 3D Spatio-temporal patterns in fatalities prediction](https://arxiv.org/abs/2604.21067)
*Thomas Schincariol*
...
### [28] [Model quality in football: Quantifying the quality of an Expected Threat model](https://arxiv.org/abs/2604.21087)
...
### [29] [Legal Infrastructure Organizes Eviction: Evidence from Philadelphia](https://arxiv.org/abs/2604.21212)
...
### [30] [Optimal basis risk weighting in expectile-based parametric insurance](https://arxiv.org/abs/2604.21372)
...
### [31] [Exploring climate change effects on concurrent floods and concurrent droughts via statistical deep learning](https://arxiv.org/abs/2604.21647)
...
### [32] [Bayesian Sparsity Modeling of Shared Neural Response in Functional Magnetic Resonance Imaging Data](https://arxiv.org/abs/2604.21676)
...
### [33] [Giant spontaneous Kerr effect reveals the defect origin of macroscopic time-reversal symmetry breaking in altermagnetic MnTe](https://arxiv.org/abs/2604.21021)
...
### [34] [Studying 3D O(N) Surface CFT on the Fuzzy Sphere](https://arxiv.org/abs/2604.21091)
...
### [35] [BCS-BEC crossover of polaritonic condensates in mass-imbalanced semimetal/semiconductor microcavities](https://arxiv.org/abs/2604.21244)
...
### [36] [Condensate states in Fermi and Bose-Hubbard ladders](https://arxiv.org/abs/2604.21296)
...
### [37] [$η$-pairing in a two-band model of spinless fermions](https://arxiv.org/abs/2604.21318)
*Igor N. Karnaukhov*
...
### [38] [Pressure-Tuned Competing Electronic States in Layered Tellurides](https://arxiv.org/abs/2604.21336)
...
### [39] [Decomposing Fractional Quantum Hall Wave Functions via Operator Contraction Multiplication](https://arxiv.org/abs/2604.21434)
...
### [40] [Symplectic symmetry of quadratic-band-touching Hamiltonians in two dimensions](https://arxiv.org/abs/2604.21524)
...
### [41] [Dynamical mean-field theory for dense spin systems at finite temperature](https://arxiv.org/abs/2604.21563)
...
### [50] [Distributed Zeroth-Order Optimization with Rademacher Perturbations and Momentum Gradient Tracking](https://arxiv.org/abs/2604.21368)
...
### [56] [Convergence Rate Analysis of SOAP with Arbitrary Orthogonal Projection Matrices](https://arxiv.org/abs/2604.21616)
...
### [57] [Robust mean field control: stochastic maximum principle and variational mean field games](https://arxiv.org/abs/2604.21641)
...
### [58] [Optimal control of therapies related to an oxytaxis glioblastoma model](https://arxiv.org/abs/2604.21674)
...
### [59] [$H_2/H_{\infty}$ Control for Stochastic Differential Systems with Partial Observation](https://arxiv.org/abs/2604.21799)
...
### [60] [Lectures on singularity categories](https://arxiv.org/abs/2604.20875)
*Matt Booth*
...
### [61] [Strong factorization theorem for smooth vectors of exponential solvable Lie group representations](https://arxiv.org/abs/2604.20998)
...
### [62] [Quantization of nilpotent coadjoint $GL_N$-orbit closures in positive characteristics](https://arxiv.org/abs/2604.21597)
...
### [63] [The Representation Type of the Descent Algebras](https://arxiv.org/abs/2604.21619)
...
### [64] [Lusztig constants and endoscopy](https://arxiv.org/abs/2604.21703)
...
### [65] [Twisted Kazhdan-Lusztig conjecture for $p$-adic general linear group](https://arxiv.org/abs/2604.21731)
*Yuan Chai*
...
### [66] [Orthosymplectic quantum groups revisited](https://arxiv.org/abs/2604.21785)
...
### [67] [Design, Modelling and Experimental Evaluation of a Tendon-driven Wrist Abduction-Adduction Mechanism for an upper limb exoskeleton](https://arxiv.org/abs/2604.20893)
...
### [68] [A Tendon-Driven Wrist Abduction-Adduction Joint Improves Performance of a 5 DoF Upper Limb Exoskeleton -- Implementation and Experimental Evaluation](https://arxiv.org/abs/2604.20898)
...
### [69] [Clinical Evaluation of a Tongue-Controlled Wrist Abduction-Adduction Assistance in a 6-DoF Upper-Limb Exoskeleton for Individuals with ALS and SCI](https://arxiv.org/abs/2604.20967)
*Juwairiya S. Khan,Mostafa Mohammadi,Alexander L. Ammitzbøll,Ellen-Merete Hagen,Jakob Blicher Izabella Obál,Ana S. S. Cardoso,Oguzhan Kirtas,Rasmus L. Kæseler,John Rasmussen,Lotte N. S. Andreasen Struijk*
...
### [70] [A Survey of Legged Robotics in Non-Inertial Environments: Past, Present, and Future](https://arxiv.org/abs/2604.20990)
...
### [71] [Open-H-Embodiment: A Large-Scale Dataset for Enabling Foundation Models in Medical Robotics](https://arxiv.org/abs/2604.21017)
...
### [72] [Neuro-Symbolic Manipulation Understanding with Enriched Semantic Event Chains](https://arxiv.org/abs/2604.21053)
*Fatemeh Ziaeetabar*
...
### [73] [Impact-Aware Model Predictive Control for UAV Landing on a Heaving Platform](https://arxiv.org/abs/2604.21078)
...
### [74] [Self-Predictive Representation for Autonomous UAV Object-Goal Navigation](https://arxiv.org/abs/2604.21130)
...
### [75] [Navigating the Clutter: Waypoint-Based Bi-Level Planning for Multi-Robot Systems](https://arxiv.org/abs/2604.21138)
...
### [76] [Full-Body Dynamic Safety for Robot Manipulators: 3D Poisson Safety Functions for CBF-Based Safety Filters](https://arxiv.org/abs/2604.21189)
...
### [77] [How VLAs (Really) Work In Open-World Environments](https://arxiv.org/abs/2604.21192)
...
### [78] [CorridorVLA: Explicit Spatial Constraints for Generative Action Heads via Sparse Anchors](https://arxiv.org/abs/2604.21241)
...
### [79] [Reasoning About Traversability: Language-Guided Off-Road 3D Trajectory Planning](https://arxiv.org/abs/2604.21249)
...
### [80] [FingerViP: Learning Real-World Dexterous Manipulation with Fingertip Visual Perception](https://arxiv.org/abs/2604.21331)
...
### [81] [PREVENT-JACK: Context Steering for Swarms of Long Heavy Articulated Vehicles](https://arxiv.org/abs/2604.21337)
...
### [82] [SLAM as a Stochastic Control Problem with Partial Information: Optimal Solutions and Rigorous Approximations](https://arxiv.org/abs/2604.21693)
...
### [83] [Learn Weightlessness: Imitate Non-Self-Stabilizing Motions on Humanoid Robot](https://arxiv.org/abs/2604.21351)
...
### [84] [RPG: Robust Policy Gating for Smooth Multi-Skill Transitions in Humanoid Fighting](https://arxiv.org/abs/2604.21355)
...
### [85] [A Deployable Embodied Vision-Language Navigation System with Hierarchical Cognition and Context-Aware Exploration](https://arxiv.org/abs/2604.21363)
...
### [86] [A Replicable Robotics Awareness Method Using LLM-Enabled Robotics Interaction: Evidence from a Corporate Challenge](https://arxiv.org/abs/2604.21377)
...
### [87] [From Noise to Intent: Anchoring Generative VLA Policies with Residual Bridges](https://arxiv.org/abs/2604.21391)
...
### [88] [Ufil: A Unified Framework for Infrastructure-based Localization](https://arxiv.org/abs/2604.21471)
...
### [89] [MISTY: High-Throughput Motion Planning via Mixer-based Single-step Drifting](https://arxiv.org/abs/2604.21489)
...
### [90] [X2-N: A Transformable Wheel-legged Humanoid Robot with Dual-mode Locomotion and Manipulation](https://arxiv.org/abs/2604.21541)
...
### [91] [A Bayesian Reasoning Framework for Robotic Systems in Autonomous Casualty Triage](https://arxiv.org/abs/2604.21568)
...
### [92] [Effects of Swarm Size Variability on Operator Workload](https://arxiv.org/abs/2604.21707)
...
### [93] [A Compact Peristaltic Pump Based on Magneto-Elastic Hysteresis with Single Pneumatic Control](https://arxiv.org/abs/2604.21729)
...
### [94] [Hi-WM: Human-in-the-World-Model for Scalable Robot Post-Training](https://arxiv.org/abs/2604.21741)
...
### [95] [Task-Driven Co-Design of Heterogeneous Multi-Robot Systems](https://arxiv.org/abs/2604.21894)
...
### [96] [VistaBot: View-Robust Robot Manipulation via Spatiotemporal-Aware View Synthesis](https://arxiv.org/abs/2604.21914)
...
### [97] [On the reciprocity law in $\mathbb{F}_{q}[t]$](https://arxiv.org/abs/2604.20892)
*Su Hu,Enci Wang*
...
### [98] [Extremal Problems for GCDs and LCMs in Higher Dimensions](https://arxiv.org/abs/2604.21122)
*Haozhe Gou*
...
### [99] [Relations between higher level Hurwitz class numbers](https://arxiv.org/abs/2604.21157)
*Ngoc Trinh Le*
...
### [100] [Moments and joint nonvanishing of symplectic $L$-functions](https://arxiv.org/abs/2604.21195)
...
### [101] [Consecutive non-square nom-primitive pairs in as finite field](https://arxiv.org/abs/2604.21429)
*Stephen D. Cohen*
...
### [102] [The Smallest Invariant Factor of Elliptic Curves, and Coincidences](https://arxiv.org/abs/2604.21601)
...
### [103] [Galois representations over convergent de Rham period ring](https://arxiv.org/abs/2604.21605)
*Hui Gao,Yupeng Wang*
...
### [104] [Residues of a tropical zeta function for convex domains](https://arxiv.org/abs/2604.21709)
...
### [105] [Accuracy and stability of Artificial Neural Networks for HP-Splines frequency parameter selection](https://arxiv.org/abs/2604.20991)
...
### [106] [Data-Driven Surrogate Models for Agromaritime Applications: Finite Element-Neural Network Integration](https://arxiv.org/abs/2604.21058)
*Muhammad Ilyas*
...
### [107] [Old and new Schrödinger eigenvalue localisation](https://arxiv.org/abs/2604.21074)
...
### [108] [On a Boundary-Initial Value Problem for Fractional Differential Equation with Sequential Caputo derivatives](https://arxiv.org/abs/2604.21319)
...
### [109] [Spherical Cap $L_2$ Discrepancy -- Blessing of Dimensionality and a Balanced Large-Cap Variant](https://arxiv.org/abs/2604.21340)
...
### [110] [A nonconforming method for a generalized Darcy-Forchheimer model](https://arxiv.org/abs/2604.21558)
...
### [111] [Positivity-Preserving and Entropy-Stable Oscillation-Eliminating DGSEM for the Compressible Euler Equations on Curvilinear Meshes with Adaptive Mesh Refinement](https://arxiv.org/abs/2604.21600)
...
### [112] [Optimal transfer operators for nonsymmetric two-grid methods](https://arxiv.org/abs/2604.21648)
...
### [113] [Structure-preserving approximation for non-isothermal phase-field models in melt flow](https://arxiv.org/abs/2604.21697)
...
### [114] [Segment convergence for super-linear stochastic functional differential equations by the truncated Euler-Maruyama method](https://arxiv.org/abs/2604.21704)
...
### [115] [A superconvergent hybridizable discontinuous Galerkin method for the convective Cahn--Hilliard equation](https://arxiv.org/abs/2604.21719)
...
### [116] [Stable and asymptotic preserving space-time discretizations of a linear kinetic transport equation in diffusive scaling](https://arxiv.org/abs/2604.21752)
...
### [117] [Local error estimates for a finite element method combining linear and nonlinear stabilization for the linear hyperbolic transport equation](https://arxiv.org/abs/2604.21775)
...
### [118] [Norm-based convergence bounds for nonsymmetric algebraic V-cycle multigrid methods](https://arxiv.org/abs/2604.21815)
*Reinhard Nabben,Ludwig Rooch*
...
### [119] [Formulae for the Drazin inverse of Modified Tensors via the Einstein Product](https://arxiv.org/abs/2604.21818)
...
### [120] [Direct Problem for Gas Diffusion in Polar Firn with Variable Coefficients](https://arxiv.org/abs/2604.21821)
...
### [121] [Guaranteed inf-sup bounds and existence verification for semilinear elliptic problems via nonconforming finite elements](https://arxiv.org/abs/2604.21887)
*Benedikt Gräßle*
...
### [122] [A structure-preserving semi-implicit finite volume scheme on vertex-staggered unstructured meshes](https://arxiv.org/abs/2604.21906)
