...
### [3] [Time-Dependent Accretion Disks with Magnetically Driven Winds: Green's Function Solutions](https://arxiv.org/abs/2512.23999)
*Mageshwaran Tamilan*
...
### [4] [Machine-learning approaches to dispersion measure estimation for fast radio bursts](https://arxiv.org/abs/2512.24003)
...
### [5] [SSC Radiation in the ICMART Model: Spectral Simulations and Application to the Record-Breaking GRB 221009A](https://arxiv.org/abs/2512.24085)
*Xueying Shao,He Gao*
...
### [6] [Evolution of Accretion Properties in Mrk 1040 using long-term X-ray Observations](https://arxiv.org/abs/2512.24141)
...
### [7] [A Seyfert galaxy as a hidden counterpart to a neutrino-associated blazar](https://arxiv.org/abs/2512.24178)
...
### [8] [Abundance Stratification in Type Iax SN 2020rea with TARDIS](https://arxiv.org/abs/2512.24203)
...
### [9] [H.E.S.S. detection and multi-wavelength study of the $z \sim$ 1 blazar PKS 0346$-$27](https://arxiv.org/abs/2512.24228)
...
### [10] [Improved lanthanide constraints for the kilonova AT 2017gfo](https://arxiv.org/abs/2512.24257)
...
### [11] [Evidence for the transition from thermal to non-thermal emission in the prompt emission of GRB 161117A](https://arxiv.org/abs/2512.24563)
...
### [12] [The role of PSR J0614-3329 in defining the high-density matter at Neutron star cores](https://arxiv.org/abs/2512.24729)
...
### [13] [Searching for Periodicity in FRB 20240114A](https://arxiv.org/abs/2512.24936)
*J. I. Katz*
...
### [14] [Multi-Frequency Study of FRB20201124A with the uGMRT](https://arxiv.org/abs/2512.24978)
...
### [15] [A new kind of automorphic form and a proof of the essential transformation laws](https://arxiv.org/abs/2512.23823)
...
### [16] [$p$-Adic $λ$ Functions for Cyclic Mumford Curve](https://arxiv.org/abs/2512.23913)
*Yaacov Kopeliovich*
...
### [17] [The probability of isomorphic group structures of isogenous elliptic curves over finite fields](https://arxiv.org/abs/2512.23921)
...
### [18] [Integrality of a trigonometric determinant arising from a conjecture of Sun](https://arxiv.org/abs/2512.24012)
...
### [19] [Secondary Term for the Mean Value of Maass Special $L$-values](https://arxiv.org/abs/2512.24028)
*Zhi Qi*
...
### [20] [Short sums of trace functions over function fields and their applications](https://arxiv.org/abs/2512.24080)
...
### [21] [Large values of quadratic character sums revisited](https://arxiv.org/abs/2512.24147)
...
### [22] [Some Congruences Involving Fourth Powers of Generalized Central Trinomial Coefficients](https://arxiv.org/abs/2512.24148)
...
### [23] [Notes on the LVP and the CVP in $p$-adic Fields](https://arxiv.org/abs/2512.24207)
...
### [24] [Explicit bounds for the graphicality of the prime gap sequence](https://arxiv.org/abs/2512.24230)
...
### [25] [On $\mathrm{Ext}^{\bullet}$ between locally analytic generalized Steinberg with applications](https://arxiv.org/abs/2512.24279)
*Zicheng Qian*
...
### [26] [On Trivial Cyclically Covering Subspaces of $\mathbb{F}_q^n$ in Non-Coprime Characteristic](https://arxiv.org/abs/2512.24301)
...
### [27] [Regulators on some abelian coverings of $\mathbb{P}^1$ minus $n+2$ points](https://arxiv.org/abs/2512.24607)
...
### [28] [Average first-passage times for character sums](https://arxiv.org/abs/2512.24631)
...
### [29] [Rational Angle Bisection Problem in Higher Dimensional Spaces and Incenters of Simplices over Fields](https://arxiv.org/abs/2512.24660)
*Takashi Hirotsu*
...
### [30] [Counting Lattices with Local Hecke Series](https://arxiv.org/abs/2512.24690)
...
### [31] [Isomorphism between Hopf algebras for multiple zeta values](https://arxiv.org/abs/2512.24732)
...
### [32] [Green's function on the Tate curve](https://arxiv.org/abs/2512.24935)
...
### [33] [Number of $K$-rational points with given $j$-invariant on modular curves](https://arxiv.org/abs/2512.24817)
*Ivan Novak*
...
### [34] [On Diophantine exponents of lattices](https://arxiv.org/abs/2512.24913)
...
### [35] [The least prime with a given cycle type](https://arxiv.org/abs/2512.24963)
...
### [36] [The splitting field and generators of the elliptic surface $Y^2=X^3 +t^{360} +1$](https://arxiv.org/abs/2512.25009)
*Sajad Salami*
...
### [50] [A note on the space-time variational formulation for the wave equation with source term in $L^2(Q)$](https://arxiv.org/abs/2512.23807)
*Marco Zank*
...
### [51] [Greedy Rational Approximation for Frequency-Domain Model Reduction of Parametric LTI Systems](https://arxiv.org/abs/2512.23814)
...
### [52] [Deep learning methods for inverse problems using connections between proximal operators and Hamilton-Jacobi equations](https://arxiv.org/abs/2512.23829)
...
### [53] [Multimodal sampling via Schrödinger-Föllmer samplers with temperatures](https://arxiv.org/abs/2512.23965)
...
### [54] [High order numerical discretizations of the Einstein-Euler equations in the Generalized Harmonic formulation](https://arxiv.org/abs/2512.24121)
...
### [55] [Structure-preserving schemes for nonlinear symmetric hyperbolic and thermodynamically compatible systems of partial differential equations](https://arxiv.org/abs/2512.24127)
...
### [56] [Sufficient and Necessary Conditions for Eckart-Young-like Result for Tubal Tensors](https://arxiv.org/abs/2512.24405)
*Uria Mor*
...
### [57] [Fast high-order spectral solvers for PDEs on triangulated surfaces with applications to deforming surfaces](https://arxiv.org/abs/2512.24456)
*Gentian Zavalani*
...
### [58] [Exponential Convergence of Deep Composite Polynomial Approximation for Cusp-Type Functions](https://arxiv.org/abs/2512.24523)
...
### [59] [Newton-Krylov Methods for Computing Steady States of Particle Timesteppers via Optimal Transport](https://arxiv.org/abs/2512.24567)
...
### [60] [Solving the inverse Source Problems for wave equation with final time measurements by a data driven approach](https://arxiv.org/abs/2512.24647)
...
### [61] [Boundary error control for numerical solution of BSDEs by the convolution-FFT method](https://arxiv.org/abs/2512.24714)
...
### [62] [A structure-preserving parametric approximation for anisotropic geometric flows via an $α$-surface energy matrix](https://arxiv.org/abs/2512.24875)
...
### [63] [Random compressible Euler flows](https://arxiv.org/abs/2512.24879)
...
### [64] [A finite element approach for minimizing line and surface energies arising in the study of singularities in liquid crystals](https://arxiv.org/abs/2512.24928)
*Dominik Stantejsky*
...
### [65] [Approximating evolution operators of linear delay equations: a general framework for the convergence analysis](https://arxiv.org/abs/2512.24964)
...
### [66] [At the intersection of Numerical Analysis and Spectral Geometry](https://arxiv.org/abs/2512.25012)
*Nilima Nigam*
...
### [67] [Convergence of the generalization error for deep gradient flow methods for PDEs](https://arxiv.org/abs/2512.25017)
...
### [72] [Constraints on the perfect phylogeny mixture model and their effect on reducing degeneracy](https://arxiv.org/abs/2512.24930)
...
### [73] [Simultaneous Extrinsic Contact and In-Hand Pose Estimation via Distributed Tactile Sensing](https://arxiv.org/abs/2512.23856)
...
### [74] [Learning to Feel the Future: DreamTacVLA for Contact-Rich Manipulation](https://arxiv.org/abs/2512.23864)
...
### [75] [SHIELD: Spherical-Projection Hybrid-Frontier Integration for Efficient LiDAR-based Drone Exploration](https://arxiv.org/abs/2512.23972)
...
### [76] [Evaluation of Impression Difference of a Domestic Mobile Manipulator with Autonomous and/or Remote Control in Fetch-and-Carry Tasks](https://arxiv.org/abs/2512.24029)
...
### [77] [RflyUT-Sim: A Simulation Platform for Development and Testing of Complex Low-Altitude Traffic Control](https://arxiv.org/abs/2512.24112)
...
### [78] [Unified Embodied VLM Reasoning with Robotic Action via Autoregressive Discretized Pre-training](https://arxiv.org/abs/2512.24125)
...
### [79] [ROBOPOL: Social Robotics Meets Vehicular Communications for Cooperative Automated Driving](https://arxiv.org/abs/2512.24129)
...
### [80] [GR-Dexter Technical Report](https://arxiv.org/abs/2512.24210)
...
### [81] [RANGER: A Monocular Zero-Shot Semantic Navigation Framework through Contextual Adaptation](https://arxiv.org/abs/2512.24212)
...
### [82] [Heteroscedastic Bayesian Optimization-Based Dynamic PID Tuning for Accurate and Robust UAV Trajectory Tracking](https://arxiv.org/abs/2512.24249)
...
### [83] [Local Path Optimization in The Latent Space Using Learned Distance Gradient](https://arxiv.org/abs/2512.24272)
...
### [84] [DRL-TH: Jointly Utilizing Temporal Graph Attention and Hierarchical Fusion for UGV Navigation in Crowded Environments](https://arxiv.org/abs/2512.24284)
...
### [90] [Counterfactual VLA: Self-Reflective Vision-Language-Action Model with Adaptive Reasoning](https://arxiv.org/abs/2512.24426)
...
### [91] [Subsecond 3D Mesh Generation for Robot Manipulation](https://arxiv.org/abs/2512.24428)
...
### [92] [Foundation models on the bridge: Semantic hazard detection and safety maneuvers for maritime autonomy with vision-language models](https://arxiv.org/abs/2512.24470)
...
### [93] [DISF: Disentangled Iterative Surface Fitting for Contact-stable Grasp Planning with Grasp Pose Alignment to the Object Center of Mass](https://arxiv.org/abs/2512.24550)
...
### [94] [Resolving State Ambiguity in Robot Manipulation via Adaptive Working Memory Recoding](https://arxiv.org/abs/2512.24638)
...
### [95] [Hybrid Motion Planning with Deep Reinforcement Learning for Mobile Robot Navigation](https://arxiv.org/abs/2512.24651)
...
### [96] [RoboMIND 2.0: A Multimodal, Bimanual Mobile Manipulation Dataset for Generalizable Embodied Intelligence](https://arxiv.org/abs/2512.24653)
...
### [97] [Antagonistic Bowden-Cable Actuation of a Lightweight Robotic Hand: Toward Dexterous Manipulation for Payload Constrained Humanoids](https://arxiv.org/abs/2512.24657)
...
### [98] [VLA-RAIL: A Real-Time Asynchronous Inference Linker for VLA Models and Robots](https://arxiv.org/abs/2512.24673)
...
### [99] [ReSPIRe: Informative and Reusable Belief Tree Search for Robot Probabilistic Search and Tracking in Unknown Environments](https://arxiv.org/abs/2512.24680)
...
### [100] [CREPES-X: Hierarchical Bearing-Distance-Inertial Direct Cooperative Relative Pose Estimation System](https://arxiv.org/abs/2512.24688)
...
### [101] [Dynamic Policy Learning for Legged Robot with Simplified Model Pretraining and Model Homotopy Transfer](https://arxiv.org/abs/2512.24698)
...
### [103] [Control of Microrobots with Reinforcement Learning under On-Device Compute Constraints](https://arxiv.org/abs/2512.24740)
...
### [104] [Dream2Flow: Bridging Video Generation and Open-World Manipulation with 3D Object Flow](https://arxiv.org/abs/2512.24766)
...
### [105] [ArtiSG: Functional 3D Scene Graph Construction via Human-demonstrated Articulated Objects Manipulation](https://arxiv.org/abs/2512.24845)
...
### [106] [Hierarchical Deformation Planning and Neural Tracking for DLOs in Constrained Environments](https://arxiv.org/abs/2512.24974)
...
### [107] [Coordinated Humanoid Manipulation with Choice Policies](https://arxiv.org/abs/2512.25072)
...
### [108] [Yu-Shiba-Rusinov bound states of exciton condensate](https://arxiv.org/abs/2512.23724)
...
### [109] [Hedgehog lattices induced by chiral spin interactions](https://arxiv.org/abs/2512.23798)
...
### [110] [Origin of insulating state in bulk $1T$-TaS$_2$ revealed by out-of-plane dimerization](https://arxiv.org/abs/2512.23883)
...
### [111] [Fragile Topological Phases and Topological Order of 2D Crystalline Chern Insulators](https://arxiv.org/abs/2512.24709)
...
### [112] [Lectures on insulating and conducting quantum spin liquids](https://arxiv.org/abs/2512.23962)
*Subir Sachdev*
...
### [113] [Correlated 5f electronic states and phase stability in americium under high pressure: Insights from DFT+DMFT calculations](https://arxiv.org/abs/2512.23963)
*Haiyan Lu*
...
### [114] [Skyrmion and Meron Crystals in Intermetallic Gd$_3$Ru$_4$Al$_{12}$: Microscopic Model Insights into Chiral Phases](https://arxiv.org/abs/2512.24071)
...
### [115] [Exactly Solvable Models Hosting Altermagnetic Quantum Spin Liquids](https://arxiv.org/abs/2512.24076)
...
### [116] [Les Houches Lectures Notes on Tensor Networks](https://arxiv.org/abs/2512.24390)
...
### [117] [Detection of a Rényi Index Dependent Transition in Entanglement Entropy Scaling](https://arxiv.org/abs/2512.24533)
...
### [118] [Disentangle Intertwined Interactions in Correlated Charge Density Wave with Magnetic Impurities](https://arxiv.org/abs/2512.24668)
...
### [119] [Intriguing Magnetocaloric Effect in 6H-perovskite Ba3RRu2O9 (R=Ho, Gd, Tb, Nd) with Strong 4d-4f Correlations](https://arxiv.org/abs/2512.24758)
...
### [120] [Quasiparticle Dynamics in the 4d-4f Ising-like Double Perovskite Ba2DyRuO6 Probed by Neutron Scattering and Machine-Learning Framework](https://arxiv.org/abs/2512.24778)
...
### [121] [Parity order as a fundamental driver of bosonic topology](https://arxiv.org/abs/2512.25011)
...
### [122] [Perturbative Kondo destruction and global phase diagram of heavy fermion metals](https://arxiv.org/abs/2512.25036)
...
### [123] [Emergence of 3D Superconformal Ising Criticality on the Fuzzy Sphere](https://arxiv.org/abs/2512.25054)
...
### [124] [Classification of Interacting Topological Crystalline Superconductors in Three Dimensions and Beyond](https://arxiv.org/abs/2512.25069)
...
### [125] [Forecasting the Term Structure of Interest Rates with SPDE-Based Models](https://arxiv.org/abs/2512.23910)
...
### [126] [Exposed: Shedding Blacklight on Online Privacy](https://arxiv.org/abs/2512.24041)
...
### [127] [The Malaysian Election Corpus (MECo): Electoral Maps and Cartograms from 1954 to 2025](https://arxiv.org/abs/2512.24211)
...
### [128] [$\ell_0$-Regularized Item Response Theory Model for Robust Ideal Point Estimation](https://arxiv.org/abs/2512.24642)
...
### [129] [Stochastic Galerkin Method and Hierarchical Preconditioning for PDE-constrained Optimization](https://arxiv.org/abs/2512.23804)
...
### [130] [The Flow-Limit of Reflect-Reflect-Relax: Existence, Stability, and Discrete-Time Behavior](https://arxiv.org/abs/2512.23843)
*Manish Krishan Lal*
...
### [131] [Policy Mirror Descent with Temporal Difference Learning: Sample Complexity under Online Markov Data](https://arxiv.org/abs/2512.24056)
...
### [132] [Complexity and convergence analysis of a single-loop SDCAM for Lipschitz composite optimization and beyond](https://arxiv.org/abs/2512.24059)
...
### [133] [Complete lift of control system](https://arxiv.org/abs/2512.24262)
...
### [134] [Adaptive Algorithms for Nonconvex Bilevel Optimization under PŁ Conditions](https://arxiv.org/abs/2512.24291)
...
### [135] [Optimization over Trained Neural Networks: Going Large with Gradient-Based Algorithms](https://arxiv.org/abs/2512.24295)
...
### [136] [Approximation algorithms for integer programming with resource augmentation](https://arxiv.org/abs/2512.24302)
...
### [137] [Discrete-Time Mean Field Type Games: Probabilistic Setup](https://arxiv.org/abs/2512.24313)
...
### [138] [Backpropagation from KL Projections: Differential and Exact I-Projection Correspondences](https://arxiv.org/abs/2512.24335)
*Manish Krishan Lal*
...
### [139] [Decentralized Optimization over Time-Varying Row-Stochastic Digraphs](https://arxiv.org/abs/2512.24483)
...
### [140] [A Study on the Algorithm and Implementation of SDPT3](https://arxiv.org/abs/2512.24623)
*Naoki Ito*
...
### [141] [A Differential Game with Symmetric Incomplete Information on Probabilistic Initial Condition and with Signal Revelation](https://arxiv.org/abs/2512.24640)
*Xiaochi Wu*
...
### [142] [A New Decomposition Paradigm for Graph-structured Nonlinear Programs via Message Passing](https://arxiv.org/abs/2512.24676)
...
### [143] [A proximal subgradient algorithm for constrained multiobjective DC-type optimization](https://arxiv.org/abs/2512.24717)
...
### [144] [Some Studies on Stochastic Optimization based Quantitative Risk Management](https://arxiv.org/abs/2512.24736)
*Zhaolin Hu*
...
### [145] [A first approximation algorithm for the Bin Packing Problem with Setups](https://arxiv.org/abs/2512.24785)
...
### [146] [Tensor Based Proximal Alternating Minimization Method for A Kind of Inhomogeneous Quartic Optimization Problem](https://arxiv.org/abs/2512.24872)
...
### [147] [Adaptive Clutter Suppression via Convex Optimization](https://arxiv.org/abs/2512.24889)
...
### [148] [Self-Supervised Amortized Neural Operators for Optimal Control: Scaling Laws and Applications](https://arxiv.org/abs/2512.24897)
...
### [149] [A Pontryagin Maximum Principle on the Belief Space for Continuous-Time Optimal Control with Discrete Observations](https://arxiv.org/abs/2512.24916)
...
### [150] [Strengthening Dual Bounds for Multicommodity Capacitated Network Design with Unsplittable Flow Constraints](https://arxiv.org/abs/2512.25018)
...
### [151] [Pair Space in Classical Mechanics III. Some Four-Body Central Configurations](https://arxiv.org/abs/2512.23730)
*Alon Drory*
...
### [152] [Adjoint L-Infinity Actions and Conserved Charges in GR](https://arxiv.org/abs/2512.23970)
...
### [153] [On spectral equations for an evolution operator of a $q$-oscillator lattice](https://arxiv.org/abs/2512.24043)
*Sergey Sergeev*
...
### [154] [Quantum two-dimensional superintegrable systems in flat space: exact-solvability, hidden algebra, polynomial algebra of integrals](https://arxiv.org/abs/2512.24045)
...
### [155] [Tensor-Network Analysis of Root Patterns in the XXX Model with Open Boundaries](https://arxiv.org/abs/2512.24182)
...
### [157] [Quasicrystalline Gibbs states in 4-dimensional lattice-gas models with finite-range interactions](https://arxiv.org/abs/2512.24436)
...
### [158] [From Yang-Mills to Yang-Baxter: In Memory of Rodney Baxter and Chen--Ning Yang](https://arxiv.org/abs/2512.24494)
*Bai-Ling Wang*
...
### [159] [Collective behaviors of an electron gas in the mean-field regime](https://arxiv.org/abs/2512.24666)
*Dong Hao Ou Yang*
...
### [160] [Products of random Hermitian matrices and brickwork Hurwitz numbers. Products of normal matrices](https://arxiv.org/abs/2512.24720)
*Ch. Li,A. Yu. Orlov*
...
### [161] [Geometric approaches to Lie bialgebras, their classification, and applications](https://arxiv.org/abs/2512.24795)
*Daniel Wysocki*
...
### [162] [Numerical study of solitary waves in Dirac--Klein--Gordon system](https://arxiv.org/abs/2512.24954)
...
### [163] [Bilinear tau forms of quantum Painlevé equations and $\mathbb{C}^2/\mathbb{Z}_2$ blowup relations in SUSY gauge theories](https://arxiv.org/abs/2512.25051)
...
### [164] [Filtered cospans and interlevel persistence with boundary conditions](https://arxiv.org/abs/2512.24025)
*Michael Usher*
...
### [165] [Polynomial functors over free nilpotent groups](https://arxiv.org/abs/2512.24048)
*Minkyu Kim*
...
### [166] [Coherent span-valued 2D TQFTs](https://arxiv.org/abs/2512.24887)
