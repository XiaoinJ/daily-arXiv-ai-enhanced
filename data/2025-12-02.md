...
### [1] [Computing the Bottleneck Distance between Persistent Homology Transforms](https://arxiv.org/abs/2512.00821)
...
### [3] [Magnetized Shocks Mediated by Radiation from Leptonic and Hadronic Processes](https://arxiv.org/abs/2512.00155)
...
### [4] [Excitation of molecular hydrogen by cosmic-ray protons](https://arxiv.org/abs/2512.00474)
...
### [5] [Normal or transitional? The evolution and properties of two type Ia supernovae in the Virgo cluster](https://arxiv.org/abs/2512.00555)
...
### [6] [Particle Astrophysics with High and Ultrahigh Energy Neutrinos](https://arxiv.org/abs/2512.00660)
...
### [7] [Broadband Spectral Analysis of 1ES2344+514: A Multi-epoch study](https://arxiv.org/abs/2512.00750)
...
### [8] [Can the Efron-Petrosian Method Recover the Inverse-Square Distance Law for Simulated Radio Pulsar Fluxes?](https://arxiv.org/abs/2512.00784)
...
### [9] [Tidal disruption and evaporation of rubble-pile and monolithic bodies as a source of flaring activity in Sgr A^\star$](https://arxiv.org/abs/2512.00808)
...
### [10] [Images of shadow and thin accretion disk around Bardeen black hole surrounded by perfect fluid dark matter](https://arxiv.org/abs/2512.00824)
...
### [11] [Thermal conduction and thermopower of inner crusts of magnetized neutron stars](https://arxiv.org/abs/2512.00874)
...
### [12] [Nonlinear Orbital Variations in Binary Radio Pulsars from Lense-Thirring Precession](https://arxiv.org/abs/2512.00963)
*Emmanuel Fonseca*
...
### [13] [Impact of positrons on electrical conductivity of hot and dense astrophysical plasma](https://arxiv.org/abs/2512.01044)
...
### [14] [The jetted NLS1 1H 0323+342: the Rosetta stone for accretion/ejection in AGN](https://arxiv.org/abs/2512.01053)
*Luigi Foschini*
...
### [15] [Revisiting the Supernova Engines in the 3C 397 and W49B Supernova Remnants](https://arxiv.org/abs/2512.01176)
...
### [16] [Multi-frequency radio-continuum study of the LMC SNR N206 (Goat's Eye) and its "zig-zag" PWN](https://arxiv.org/abs/2512.01221)
...
### [17] [Equivalence of Stability Criteria for Multi-Fluid Stars](https://arxiv.org/abs/2512.01640)
...
### [18] [Non-detection of FAST and Parkes follow-up observation for 27 Parkes discovered FRBs](https://arxiv.org/abs/2512.01281)
...
### [19] [Stability of Neutron-Dark Matter Mixed Stars and Hybrid Stars](https://arxiv.org/abs/2512.01641)
...
### [20] [Similar Fermi-GBM sGRBs to GW/sGRB 170817A in MeV-GeV energies](https://arxiv.org/abs/2512.01387)
...
### [21] [The impact of Solar magnetic field configurations on the production of gamma rays at the Solar disk](https://arxiv.org/abs/2512.01403)
...
### [22] [Bayesian inferences on covariant density functionals from multimessenger astrophysical data: The influences of parametrizations of density dependent couplings](https://arxiv.org/abs/2512.01503)
...
### [23] [Type IIP SN 2024bch: Hydrodynamic model, shock breakout, and circumstellar interaction](https://arxiv.org/abs/2512.01552)
...
### [24] [From Black Hole to Galaxy: Neural Operator: Framework for Accretion and Feedback Dynamics](https://arxiv.org/abs/2512.01576)
...
### [25] [An outflow from the X-ray corona as the origin of millimeter emission from radio-quiet AGN](https://arxiv.org/abs/2512.01662)
...
### [26] [LST-1 follow-up of the exceptionally bright gamma-ray burst GRB 221009A](https://arxiv.org/abs/2512.01747)
...
### [27] [Witt type Realizations of 2-D Cayley-Klein Algebras with non-zero curvatures](https://arxiv.org/abs/2512.00064)
*Arindam Chakraborty*
...
### [28] [Topological Recursion, explicit ABCD tensors and implementation](https://arxiv.org/abs/2512.00128)
*Bertrand Eynard*
...
Abstract: We provide explicit expressions of ABCD tensors for the most classical classes of spectral curves. And we discuss algorithmic implementation of Topological Recursion.

</details>


### [29] [A unified approach to spinor duals via Clifford algebras and $G_Ω$ groups](https://arxiv.org/abs/2512.00238)
...
### [31] [On the eigenvalues of a central configuration](https://arxiv.org/abs/2512.00661)
...
### [33] [Generalized Boltzmann-Gibbs Distribution and the Electronic Partition Function Paradox](https://arxiv.org/abs/2512.00894)
...
### [35] [An Adaptive Physics-Driven Deep Learning Framework for a Two-Phase Stefan Problem](https://arxiv.org/abs/2512.01011)
...
### [37] [A novel chain of Lie algebras and its coalgebra symmetry](https://arxiv.org/abs/2512.01791)
...
### [38] [Higher-order spectral form factors of circular unitary ensemble](https://arxiv.org/abs/2512.01304)
...
### [39] [Around the semi-classical limit of boundary Liouville conformal field theory](https://arxiv.org/abs/2512.01430)
*Baptiste Cerclé*
...
Abstract: Liouville conformal field theory describes a random geometry that fluctuates around a deterministic one: the unique solution of the problem of finding, within a given conformal class, a Riemannian metric with prescribed scalar and geodesic curvatures as well as conical singularities and corners. The level of randomness in Liouville theory is measured by the coupling constant $γ\in(0,2)$, the semi-classical limit corresponding to taking $γ\to0$.
  Based on the probabilistic definition of Liouville theory, we prove that this semi-classical limit exists and does give rise to this deterministic geometry. At second order this limit is described in terms of a massive Gaussian free field with Robin boundary conditions.
  This in turn allows to implement CFT-inspired techniques in a deterministic setting: in particular we define the classical stress-energy tensor, show that it can be expressed in terms of accessory parameters (written as regularized derivatives of the Liouville action), and that it gives rise to classical higher equations of motion.

</details>


### [40] [Statistical Properties of the Rooted-Tree Encoding of $\mathbb{N}$](https://arxiv.org/abs/2512.01436)
...
Abstract: We prime-encode the natural numbers via recursive factorisation, iterated to the exponents, generating a corpus of planar rooted trees equivalently represented as Dyck words. This forms a deterministic text endowed with internal rules. Statistical analysis of the corpus reveals that the dictionary and the entropy grow sublinearly, compression shows non-monotonic trend, and the rank-frequency curves assume a stable parabolic form deviating from Zipf's law. Correlation analysis using mean-squared displacement reveals a transition from normal diffusion to superdiffusion in the associated walk. These findings characterise the tree-encoded sequence as a statistically structured text with long-range correlations grounded in its generative arithmetic law, providing an empirical basis for subsequent theoretical and learnability

</details>


### [41] [Robustness and resilience of dynamical networks in biology and epidemiology](https://arxiv.org/abs/2512.01462)
...
### [42] [Augmentation and Bulk Edge Correspondence for one dimensional aperiodic tight binding operators](https://arxiv.org/abs/2512.01555)
...
### [43] [Continuity inequalities for sandwiched Rényi and Tsallis conditional entropies with application to the channel entropy continuity](https://arxiv.org/abs/2512.01745)
*Anna Vershynina*
...
### [44] [Spatial self-organization stabilizes obligate mutualism through pattern formation](https://arxiv.org/abs/2512.00254)
...
Abstract: Large animal groups -- bird flocks, fish schools, insect swarms -- are often assumed to form by gradual aggregation of sparsely distributed individuals. Using a mathematically precise framework based on time-varying directed interaction networks, we show that this widely held view is incomplete.
  ...
  The framework yields testable predictions for STARFLAG-style 3D datasets, offering a unified explanation for the formation, maintenance, and geometry of coordinated animal groups.
...
### [46] [Exact Decentralized Optimization via Explicit $\ell_1$ Consensus Penalties](https://arxiv.org/abs/2512.00268)
*Hong Wang*
...
### [47] [A multilevel proximal trust-region method for nonsmooth optimization with applications](https://arxiv.org/abs/2512.00538)
...
### [48] [Optimal Control of McKean--Vlasov Branching Diffusion Processes](https://arxiv.org/abs/2512.00633)
...
### [49] [Cosine-Similarity Methods for Efficient Training and Sampling in High-Dimensional Latent Spaces](https://arxiv.org/abs/2512.00684)
...
### [50] [A warmstarting technique for general conic optimization in interior point methods](https://arxiv.org/abs/2512.00693)
...
### [51] [Constructing control landscape for non-convex optimal control of elliptic equation by PDE-constrained high-index saddle dynamics](https://arxiv.org/abs/2512.00732)
...
### [52] [On Approximation Algorithms for Commutative Quaternion Polynomial Optimization](https://arxiv.org/abs/2512.00779)
...
### [53] [Accurately modeling long-term storage with minimum representative hours in large-scale renewable energy systems](https://arxiv.org/abs/2512.00892)
...
### [54] [A Dual-Mode Framework for Mean-Field Systems: Model-Based $H_2/H_\infty$ Control with Jump Diffusions and Model-Free Reinforcement Learning](https://arxiv.org/abs/2512.01000)
...
### [55] [Games with infinite past](https://arxiv.org/abs/2512.01001)
...
### [56] [MP and DPP for Mean-Variance Portfolio Selection Problem with Poisson Jumps, Recursive Utility and Their Relationship](https://arxiv.org/abs/2512.01378)
...
### [57] [Bayesian Distributionally Robust Merton Problem with Nonlinear Wasserstein Projections](https://arxiv.org/abs/2512.01408)
...
### [58] [Competition among seaports through Mean Field Games and real-world data](https://arxiv.org/abs/2512.01438)
...
### [59] [Approximate Stability of Subadditive Games and Traveling Salesman Games](https://arxiv.org/abs/2512.01470)
...
### [60] [On robotic manipulators with time-dependent inertial parameters: From physical consistency to boundedness of the mass matrix](https://arxiv.org/abs/2512.01482)
...
### [61] [Exact Objective Space Contraction for the Preprocessing of Multi-objective Integer Programs](https://arxiv.org/abs/2512.01535)
...
### [62] [Deep FlexQP: Accelerated Nonlinear Programming via Deep Unfolding](https://arxiv.org/abs/2512.01565)
...
### [63] [The Maxmin Value of Repeated Games with Incomplete Information on One Side and Tail-Measurable Payoffs](https://arxiv.org/abs/2512.01581)
...
### [64] [Bayesian Ambiguity Contraction-based Adaptive Robust Markov Decision Processes for Adversarial Surveillance Missions](https://arxiv.org/abs/2512.01660)
*Jimin Choi,Max Z. Li*
...
### [65] [Experiment design using prior knowledge on controllability and stabilizability](https://arxiv.org/abs/2512.01876)
...
### [66] [Observation of the rare baryonic decay B^+ -> p \antiLambda and measurement of its weak decay parameter](https://arxiv.org/abs/2512.00328)
...
Abstract: The first observation of the decay $\Bp\rightarrow \proton \Lbar$ is presented, using proton-proton collision data collected by the LHCb experiment between 2016 and 2018 at a center-of-mass energy of $13\tev$, corresponding to an integrated luminosity of $5.4\invfb$. The signal significance exceeds seven standard deviations. Using the $\Bp \rightarrow \KS \pip$ decay as a normalization channel, the branching fraction is measured and combined with previous LHCb results based on data collected at 7 and $8\tev$ in 2011 and 2012, yielding \begin{eqnarray}
  \BF(\Bp\rightarrow \proton \Lbar) = (1.24\pm0.17\pm0.05\pm0.03)\times10^{-7}\,,\nonumber \end{eqnarray} where the first uncertainty is statistical, the second is systematic, and the third comes from the uncertainty on the branching fraction of the normalization channel. The $\Bp\rightarrow \proton \Lbar$ weak decay parameter is measured to be $α_B = 0.87_{-0.29}^{+0.26} \pm 0.09$, indicating the presence of comparable S-wave and P-wave decay amplitudes.

</details>


### [67] [Measurements of electroweak production of a photon in association with two jets in proton-proton collisions at $\sqrt{s}$ = 13 TeV](https://arxiv.org/abs/2512.00502)
*CMS Collaboration*
...
### [68] [A Survey of the Latin American High Energy Physics community on the future flagship project at CERN for the ESPP Update](https://arxiv.org/abs/2512.00826)
*Reina Camacho,Melissa Cruz,Salvatore Mele,Fernando Monticelli,Martijn Mulders,Rogerio Rosenfeld,Carlos Sandoval,Maria Elena Tejeda-Yeomans*
...
### [71] [Learning to Reconstruct: A Differentiable Approach to Muon Tracking at the LHC](https://arxiv.org/abs/2512.01647)
...
### [72] [Feasibility Study of Pion and Kaon Structure via the Sullivan Process at EicC](https://arxiv.org/abs/2512.01720)
...
### [73] [A Comprehensive Survey on Surgical Digital Twin](https://arxiv.org/abs/2512.00019)
...
### [74] [Foundation Models for Trajectory Planning in Autonomous Driving: A Review of Progress and Open Challenges](https://arxiv.org/abs/2512.00021)
...
### [75] [XFlowMP: Task-Conditioned Motion Fields for Generative Robot Planning with Schrodinger Bridges](https://arxiv.org/abs/2512.00022)
...
### [76] [Fast, Robust, Permutation-and-Sign Invariant SO(3) Pattern Alignment](https://arxiv.org/abs/2512.00659)
...
### [77] [Learning from Watching: Scalable Extraction of Manipulation Trajectories from Human Videos](https://arxiv.org/abs/2512.00024)
*X. Hu,G. Ye*
...
### [78] [A Survey on Improving Human Robot Collaboration through Vision-and-Language Navigation](https://arxiv.org/abs/2512.00027)
...
### [79] [Perturbation-mitigated USV Navigation with Distributionally Robust Reinforcement Learning](https://arxiv.org/abs/2512.00030)
...
### [80] [Intelligent Systems and Robotics: Revolutionizing Engineering Industries](https://arxiv.org/abs/2512.00033)
...
### [81] [Design And Control of A Robotic Arm For Industrial Applications](https://arxiv.org/abs/2512.00034)
...
### [82] [ICD-Net: Inertial Covariance Displacement Network for Drone Visual-Inertial SLAM](https://arxiv.org/abs/2512.00037)
...
### [83] [VISTAv2: World Imagination for Indoor Vision-and-Language Navigation](https://arxiv.org/abs/2512.00041)
...
### [84] [Causal Reinforcement Learning based Agent-Patient Interaction with Clinical Domain Knowledge](https://arxiv.org/abs/2512.00048)
...
### [85] [Socially aware navigation for mobile robots: a survey on deep reinforcement learning approaches](https://arxiv.org/abs/2512.00049)
...
### [86] [Reinforcement Learning from Implicit Neural Feedback for Human-Aligned Robot Control](https://arxiv.org/abs/2512.00050)
*Suzie Kim*
...
### [87] [Modeling and Control of Magnetic Forces between Microrobots](https://arxiv.org/abs/2512.00051)
...
### [88] [An adaptive experience-based discrete genetic algorithm for multi-trip picking robot task scheduling in smart orchards](https://arxiv.org/abs/2512.00057)
...
### [89] [SpeedAug: Policy Acceleration via Tempo-Enriched Policy and RL Fine-Tuning](https://arxiv.org/abs/2512.00062)
...
### [90] [Enhancing Cognitive Robotics with Commonsense through LLM-Generated Preconditions and Subgoals](https://arxiv.org/abs/2512.00069)
...
### [91] [Reconfigurable Auxetic Devices (RADs) for Robotic Surface Manipulation](https://arxiv.org/abs/2512.00072)
...
### [92] [Bootstrap Dynamic-Aware 3D Visual Representation for Scalable Robot Learning](https://arxiv.org/abs/2512.00074)
...
### [93] [Arcadia: Toward a Full-Lifecycle Framework for Embodied Lifelong Learning](https://arxiv.org/abs/2512.00076)
...
### [94] [A Hierarchical Framework for Humanoid Locomotion with Supernumerary Limbs](https://arxiv.org/abs/2512.00077)
*Bowen Zhi*
...
### [95] [Hyper-GoalNet: Goal-Conditioned Manipulation Policy Learning with HyperNetworks](https://arxiv.org/abs/2512.00085)
...
### [96] ["Why the face?": Exploring Robot Error Detection Using Instrumented Bystander Reactions](https://arxiv.org/abs/2512.00262)
...
### [97] [RealAppliance: Let High-fidelity Appliance Assets Controllable and Workable as Aligned Real Manuals](https://arxiv.org/abs/2512.00287)
...
### [98] [MILE: A Mechanically Isomorphic Exoskeleton Data Collection System with Fingertip Visuotactile Sensing for Dexterous Manipulation](https://arxiv.org/abs/2512.00324)
...
### [99] [DPNet: Doppler LiDAR Motion Planning for Highly-Dynamic Environments](https://arxiv.org/abs/2512.00375)
...
### [100] [Balancing Efficiency and Fairness: An Iterative Exchange Framework for Multi-UAV Cooperative Path Planning](https://arxiv.org/abs/2512.00410)
...
### [101] [Hardware-Software Collaborative Computing of Photonic Spiking Reinforcement Learning for Robotic Continuous Control](https://arxiv.org/abs/2512.00427)
...
### [102] [Sample-Efficient Expert Query Control in Active Imitation Learning via Conformal Prediction](https://arxiv.org/abs/2512.00453)
...
### [103] [LAP: Fast LAtent Diffusion Planner with Fine-Grained Feature Distillation for Autonomous Driving](https://arxiv.org/abs/2512.00470)
...
### [104] [HAVEN: Hierarchical Adversary-aware Visibility-Enabled Navigation with Cover Utilization using Deep Transformer Q-Networks](https://arxiv.org/abs/2512.00592)
...
### [105] [MS-PPO: Morphological-Symmetry-Equivariant Policy for Legged Robot Locomotion](https://arxiv.org/abs/2512.00727)
...
### [106] [SAGAS: Semantic-Aware Graph-Assisted Stitching for Offline Temporal Logic Planning](https://arxiv.org/abs/2512.00775)
...
### [107] [Sign Language Recognition using Bidirectional Reservoir Computing](https://arxiv.org/abs/2512.00777)
...
### [108] [Transforming Monolithic Foundation Models into Embodied Multi-Agent Architectures for Human-Robot Collaboration](https://arxiv.org/abs/2512.00797)
...
### [109] [A Novel MDP Decomposition Framework for Scalable UAV Mission Planning in Complex and Uncertain Environments](https://arxiv.org/abs/2512.00838)
...
### [110] [Magnetic Tactile-Driven Soft Actuator for Intelligent Grasping and Firmness Evaluation](https://arxiv.org/abs/2512.00907)
...
### [111] [Constant-Time Motion Planning with Manipulation Behaviors](https://arxiv.org/abs/2512.00939)
...
### [112] [H-Zero: Cross-Humanoid Locomotion Pretraining Enables Few-shot Novel Embodiment Transfer](https://arxiv.org/abs/2512.00971)
...
### [113] [FOM-Nav: Frontier-Object Maps for Object Goal Navigation](https://arxiv.org/abs/2512.01009)
...
### [114] [Integration of UWB Radar on Mobile Robots for Continuous Obstacle and Environment Mapping](https://arxiv.org/abs/2512.01018)
...
### [115] [CycleManip: Enabling Cyclic Task Manipulation via Effective Historical Perception and Understanding](https://arxiv.org/abs/2512.01022)
...
### [116] [VLASH: Real-Time VLAs via Future-State-Aware Asynchronous Inference](https://arxiv.org/abs/2512.01031)
...
### [117] [Autonomous Grasping On Quadruped Robot With Task Level Interaction](https://arxiv.org/abs/2512.01052)
...
### [118] [Opening the Sim-to-Real Door for Humanoid Pixel-to-Action Policy Transfer](https://arxiv.org/abs/2512.01061)
...
### [119] [Reinforcement Learning for Gliding Projectile Guidance and Control](https://arxiv.org/abs/2512.01066)
...
### [120] [Estimation of Kinematic Motion from Dashcam Footage](https://arxiv.org/abs/2512.01104)
...
### [121] [Supporting Productivity Skill Development in College Students through Social Robot Coaching: A Proof-of-Concept](https://arxiv.org/abs/2512.01105)
...
### [122] [Tactile Robotics: Past and Future](https://arxiv.org/abs/2512.01106)
*Nathan F. Lepora*
...
### [123] [Think Fast: Real-Time Kinodynamic Belief-Space Planning for Projectile Interception](https://arxiv.org/abs/2512.01108)
...
### [124] [Ethically-Aware Participatory Design of a Productivity Social Robot for College Students](https://arxiv.org/abs/2512.01111)
*Himanshi Lalwani,Hanan Salam*
...
### [125] [Real-World Reinforcement Learning of Active Perception Behaviors](https://arxiv.org/abs/2512.01188)
...
### [126] [RoboLoc: A Benchmark Dataset for Point Place Recognition and Localization in Indoor-Outdoor Integrated Environments](https://arxiv.org/abs/2512.01194)
...
### [127] [COMET: A Dual Swashplate Autonomous Coaxial Bi-copter AAV with High-Maneuverability and Long-Endurance](https://arxiv.org/abs/2512.01246)
...
### [128] [Visibility-aware Cooperative Aerial Tracking with Decentralized LiDAR-based Swarms](https://arxiv.org/abs/2512.01280)
...
### [129] [Discovering Self-Protective Falling Policy for Humanoid Robot via Deep Reinforcement Learning](https://arxiv.org/abs/2512.01336)
...
### [130] [Modality-Augmented Fine-Tuning of Foundation Robot Policies for Cross-Embodiment Manipulation on GR1 and G1](https://arxiv.org/abs/2512.01358)
...
### [131] [$\mathbf{M^3A}$ Policy: Mutable Material Manipulation Augmentation Policy through Photometric Re-rendering](https://arxiv.org/abs/2512.01446)
...
### [132] [NavForesee: A Unified Vision-Language World Model for Hierarchical Planning and Dual-Horizon Navigation Prediction](https://arxiv.org/abs/2512.01550)
...
### [133] [L2M-Calib: One-key Calibration Method for LiDAR and Multiple Magnetic Sensors](https://arxiv.org/abs/2512.01554)
...
### [134] [A Cross-Embodiment Gripper Benchmark for Rigid-Object Manipulation in Aerial and Industrial Robotics](https://arxiv.org/abs/2512.01598)
...
### [135] [Integrated YOLOP Perception and Lyapunov-based Control for Autonomous Mobile Robot Navigation on Track](https://arxiv.org/abs/2512.01608)
*Mo Chen*
...
### [136] [Dynamic Log-Gaussian Process Control Barrier Function for Safe Robotic Navigation in Dynamic Environments](https://arxiv.org/abs/2512.01668)
...
### [137] [DiG-Flow: Discrepancy-Guided Flow Matching for Robust VLA Models](https://arxiv.org/abs/2512.01715)
...
### [138] [AgriLiRa4D: A Multi-Sensor UAV Dataset for Robust SLAM in Challenging Agricultural Fields](https://arxiv.org/abs/2512.01753)
...
### [139] [IGen: Scalable Data Generation for Robot Learning from Open-World Images](https://arxiv.org/abs/2512.01773)
...
### [140] [GR-RL: Going Dexterous and Precise for Long-Horizon Robotic Manipulation](https://arxiv.org/abs/2512.01801)
...
### [141] [Much Ado About Noising: Dispelling the Myths of Generative Robotic Control](https://arxiv.org/abs/2512.01809)
...
### [142] [Is Image-based Object Pose Estimation Ready to Support Grasping?](https://arxiv.org/abs/2512.01856)
...
### [143] [NeuroHJR: Hamilton-Jacobi Reachability-based Obstacle Avoidance in Complex Environments with Physics-Informed Neural Networks](https://arxiv.org/abs/2512.01897)
...
### [144] [Real-World Robot Control by Deep Active Inference With a Temporally Hierarchical World Model](https://arxiv.org/abs/2512.01924)
...
### [145] [Guardian: Detecting Robotic Planning and Execution Errors with Vision-Language Models](https://arxiv.org/abs/2512.01946)
...
### [146] [RoaD: Rollouts as Demonstrations for Closed-Loop Supervised Fine-Tuning of Autonomous Driving Policies](https://arxiv.org/abs/2512.01993)
...
### [147] [Learning Sim-to-Real Humanoid Locomotion in 15 Minutes](https://arxiv.org/abs/2512.01996)
...
### [148] [LLM-Driven Corrective Robot Operation Code Generation with Static Text-Based Simulation](https://arxiv.org/abs/2512.02002)
...
### [149] [Learning Dexterous Manipulation Skills from Imperfect Simulations](https://arxiv.org/abs/2512.02011)
...
### [150] [ManualVLA: A Unified VLA Model for Chain-of-Thought Manual Generation and Robotic Manipulation](https://arxiv.org/abs/2512.02013)
...
### [151] [EfficientFlow: Efficient Equivariant Flow Policy Learning for Embodied AI](https://arxiv.org/abs/2512.02020)
...
### [152] [Breuil's Lattice Conjecture for GL2(K)](https://arxiv.org/abs/2512.00178)
*Hymn Chan*
...
### [153] [The $ρ$-Schwartz space](https://arxiv.org/abs/2512.00182)
...
### [154] [Lattice points in thickened parabolas and rational points near hypersurfaces](https://arxiv.org/abs/2512.00202)
*Alexander Smith*
...
### [155] [Euclidean Algorithms for Ideal Classes in Biquadratic fields: A Genus-Theoretic Perspective](https://arxiv.org/abs/2512.00337)
...
### [156] [On the Disk of Convergence of Algebraic Power Series](https://arxiv.org/abs/2512.00452)
...
### [157] [A problem of Polya](https://arxiv.org/abs/2512.00505)
*Umberto Zannier*
...
### [158] [On the maximality of the $λ$-invariants of Mazur--Tate elements](https://arxiv.org/abs/2512.00525)
...
### [159] [The diophantine equation $(2^{k}-1)(b^{k}-1)=y^{q}$](https://arxiv.org/abs/2512.00548)
*Chang Liu,Bo He*
...
### [160] [The Linear Slicing Method for Equal Sums of Like Powers: Modular and Geometric Constraints](https://arxiv.org/abs/2512.00551)
*Valery Asiryan*
...
### [161] [The possible adelic indices for elliptic curves admitting a rational cyclic isogeny](https://arxiv.org/abs/2512.00652)
...
### [162] [$p$-adic monodromy and mod $p$ unlikely intersections, II](https://arxiv.org/abs/2512.00687)
*Ruofan Jiang*
...
### [163] [Polynomial Bounds for Birch's Theorem](https://arxiv.org/abs/2512.00697)
...
### [164] [The intrinsic subgroup of an elliptic curve and Mazur's torsion theorem](https://arxiv.org/abs/2512.00787)
...
### [165] [Duality for higher local fields after Kato and Suzuki](https://arxiv.org/abs/2512.00886)
*Antoine Galet*
...
### [166] [Counting roots of unity on the graphs of Laurent series over non-Archimedean local fields](https://arxiv.org/abs/2512.00982)
*Christoph Pütz*
...
### [167] [The étale Brauer-Manin obstruction for classifying stacks](https://arxiv.org/abs/2512.01014)
...
### [168] [Growth rates of sequences governed by the squarefree properties of its translates](https://arxiv.org/abs/2512.01087)
...
### [169] [Finite-slope universal Rankin-Selberg p-adic L-function](https://arxiv.org/abs/2512.01184)
*Haonan Gu*
...
### [170] [Tree asymptotic densities in number theory](https://arxiv.org/abs/2512.01376)
...
### [171] [Some Congruences Involving Binomial Coefficient and Fermat Quotient](https://arxiv.org/abs/2512.01385)
*Wei-Wei Qi*
...
### [172] [Rigorous methods for computational number theory](https://arxiv.org/abs/2512.01588)
...
### [173] [Arithmetic closed forms count the Mersenne primes, the Fermat primes and the twin-prime pairs](https://arxiv.org/abs/2512.01680)
*Mihai Prunescu*
...
### [174] [Quantitative correlations and some problems on prime factors of consecutive integers](https://arxiv.org/abs/2512.01739)
...
### [175] [A discrete approach to Dirichlet L-functions via spectral models: special values and zeros](https://arxiv.org/abs/2512.01779)
...
### [176] [Numerical cohomology for arithmetic surfaces and applications](https://arxiv.org/abs/2512.01811)
*Wei He*
...
### [177] [Jacobi Forms of Affine Weight in Higher Cogenus and Nearly Holomorphic Functions](https://arxiv.org/abs/2512.01926)
...
### [178] [Continuous persistence landscapes](https://arxiv.org/abs/2512.00206)
...
### [183] [Neural Multiscale Decomposition for Solving The Nonlinear Klein-Gordon Equation](https://arxiv.org/abs/2512.00266)
...
### [184] [Finite Difference Method for Global Stabilization of the Viscous Burgers' Equation with Nonlinear Neumann Boundary Feedback Control](https://arxiv.org/abs/2512.00317)
...
### [185] [Finite Element Analysis for the Chafee-Infante Equation Using Distributed Feedback Control](https://arxiv.org/abs/2512.00320)
*Shishu Pal Singh,Sudeep Kundu*
...
### [186] [Iterative inversion schemes for the Born series and the reduced inverse Born series](https://arxiv.org/abs/2512.00423)
...
### [187] [Asymptotic Compatibility of the Approximate-Ball Finite Element Method for 2D Nonlocal Poisson Problem with Neumann Boundary Conditions](https://arxiv.org/abs/2512.00426)
...
### [188] [Inverse spectral problem for glassy state relaxation approximated by Prony series](https://arxiv.org/abs/2512.00507)
...
### [189] [Projected iterated Tikhonov regularization in low precision](https://arxiv.org/abs/2512.00669)
...
### [190] [Error analysis of an acceleration corrected diffusion approximation of Langevin dynamics with background flow](https://arxiv.org/abs/2512.00685)
...
### [191] [Coarse spaces using extended generalized eigenproblems for heterogeneous Helmholtz problems](https://arxiv.org/abs/2512.01002)
...
### [192] [A Provably Efficient Method for Tensor Ring Decomposition and Its Applications](https://arxiv.org/abs/2512.01016)
...
### [193] [Randomized-Accelerated FEAST: A Hybrid Approach for Large-Scale Eigenvalue Problems](https://arxiv.org/abs/2512.01257)
*Ayush Nadiger*
...
### [194] [A high-order weighted positive and flux conservative method for the Vlasov equation](https://arxiv.org/abs/2512.01322)
...
### [195] [A note on the central-upwind scheme for nonlocal conservation laws](https://arxiv.org/abs/2512.01344)
...
### [196] [The Power Method for Non-Hermitian Dual Quaternion Matrices](https://arxiv.org/abs/2512.01414)
...
### [197] [Feedback Integrators Revisited](https://arxiv.org/abs/2512.01528)
...
### [198] [Tree-cotree gauging for two-dimensional hierarchical splines](https://arxiv.org/abs/2512.01580)
...
### [199] [Convergence of long-time stable variable-step arbitrary order ETD-MS scheme for gradient flows with Lipschitz nonlinearity](https://arxiv.org/abs/2512.01601)
...
### [200] [Ergodicity and invariant measure approximation of the stochastic Cahn-Hilliard equation via an explicit fully discrete scheme](https://arxiv.org/abs/2512.01621)
...
### [201] [A Two-Stage Fourth-Order Implicit Scheme for Stiff problems](https://arxiv.org/abs/2512.01628)
*Zhixin Huo*
...
### [202] [Two-level additive Schwarz preconditioners for reduced integration methods](https://arxiv.org/abs/2512.01706)
...
### [203] [A decoupled, unconditionally stable and second-order integrator for the Landau--Lifshitz--Gilbert equation with magnetoelastic effects](https://arxiv.org/abs/2512.01741)
...
### [204] [The mixed discontinuous Galerkin method for the Oseen eigenvalue problem](https://arxiv.org/abs/2512.01839)
...
### [205] [Uniform Norm Error Estimates for 2D Turning Point Problem](https://arxiv.org/abs/2512.01841)
...
### [206] [Preconditioning a Fluid--Structure Interaction Problem Using Monolithic and Block Domain Decomposition Methods for the Fluid](https://arxiv.org/abs/2512.01887)
...
### [207] [The Lebesgue constant for uniform approximation of differential forms](https://arxiv.org/abs/2512.01944)
...
### [208] [Basis Choices for Frequency Domain Statistical Independence Tests and Algorithms for Algebraic Relation Extraction](https://arxiv.org/abs/2512.01963)
...
### [209] [Exploring the apparent violation of the Mott relation in a noncentrosymmetric kagome ferromagnet](https://arxiv.org/abs/2512.00173)
...
### [210] [Robust semiclassical magnetization plateau in the kagome lattice](https://arxiv.org/abs/2512.00223)
...
### [211] [Magnetosynthesis effect on the structure and ground state of Cu$^{2+}$-based antiferromagnets](https://arxiv.org/abs/2512.00253)
...
### [212] [Precise computation of universal corner entanglement entropy at 2+1 dimension: From Ising to Gaussian quantum critical points](https://arxiv.org/abs/2512.00382)
...
### [213] [Altermagnetic boosting of chiral phonons](https://arxiv.org/abs/2512.00388)
...
### [214] [Near-flat-band-driven violation of Pauli limit in heavy fermion superconductors](https://arxiv.org/abs/2512.00486)
...
### [215] [Dressing composite fermions with artificial intelligence](https://arxiv.org/abs/2512.00527)
*Mytraya Gattu*
...
### [216] [Spin-resolved Mott crossover and entanglement in the half-filled Hubbard model](https://arxiv.org/abs/2512.00613)
...
### [217] [Bi-altermagnetism unveiled by sublattice-specific circular dichroism in resonant inelastic X-ray scattering](https://arxiv.org/abs/2512.00737)
...
### [218] [Evidence for itinerant electron-local moment interaction in Li-doped $α$-MnTe](https://arxiv.org/abs/2512.00747)
...
### [219] [Electric-field driven flat bands in the distorted sawtooth chain via the Katsura-Nagaosa-Balatsky mechanism](https://arxiv.org/abs/2512.00900)
...
### [220] [Magnetic clusters in the paramagnetic phase of a high-temperature ferromagnetic metal-organic framework](https://arxiv.org/abs/2512.00980)
...
### [221] [Dynamics of superconducting pairs in the two-dimensional Hubbard model](https://arxiv.org/abs/2512.01124)
...
### [222] [Generalized Nagaoka ferromagnetism accompanied by flavor-selective Mott states in an SU($N$) Fermi-Hubbard model](https://arxiv.org/abs/2512.01264)
...
### [223] [Disorder Suppression of Charge Density Wave in the Honeycomb Holstein Model](https://arxiv.org/abs/2512.01487)
...
### [224] [$\mathbb{Z}_2$ Vortex Crystal Candidate in the Triangular $S=1/2$ Quantum Antiferromagnet](https://arxiv.org/abs/2512.01793)
...
### [225] [Anomalous Eigenstates of a Doped Hole in the Ising Antiferromagnet](https://arxiv.org/abs/2512.01815)
...
### [226] [Refining Heuristic Predictors of Fractional Chern Insulators using Machine Learning](https://arxiv.org/abs/2512.01873)
...
### [227] [Heterometallic spin-1/2 quantum magnet under hydrostatic pressure](https://arxiv.org/abs/2512.01994)
...
### [228] [Beyond Expected Goals: A Probabilistic Framework for Shot Occurrences in Soccer](https://arxiv.org/abs/2512.00203)
...
### [229] [Bayesian Analysis of Hotel Booking Cancellations: A Hierarchical Modeling Approach](https://arxiv.org/abs/2512.00240)
*Yingdong Yang*
...
### [230] [Robust Wrapped Gaussian Process Inference for Noisy Angular Data](https://arxiv.org/abs/2512.00277)
...
### [231] [Kicking for Goal or Touch? An Expected Points Framework for Penalty Decisions in Rugby Union](https://arxiv.org/abs/2512.00312)
...
### [232] [Exploring Student Interactions with AI-Powered Learning Tools: A Qualitative Study Connecting Interaction Patterns to Educational Learning Theories](https://arxiv.org/abs/2512.00519)
...
### [233] [A State-Space Approach to Modeling Tire Degradation in Formula 1 Racing](https://arxiv.org/abs/2512.00640)
...
### [234] [Model-based indicators for co-clustered environments and species communities](https://arxiv.org/abs/2512.00678)
...
### [235] [A Clinical Instrument to Measure Patient Anecdotes in Clinical Trials](https://arxiv.org/abs/2512.01041)
...
### [236] [pvEBayes: An R Package for Empirical Bayes Methods in Pharmacovigilance](https://arxiv.org/abs/2512.01057)
...
### [237] [COVID-19 Forecasting from U.S. Wastewater Surveillance Data: A Retrospective Multi-Model Study (2022-2024)](https://arxiv.org/abs/2512.01074)
...
### [238] [Bayesian Statistical Inversion for High-Dimensional Computer Model Output and Spatially Distributed Counts](https://arxiv.org/abs/2512.01927)
...
### [239] [Predicting Onsets and Dry Spells of the West African Monsoon Season Using Machine Learning Methods](https://arxiv.org/abs/2512.01965)
...
### [240] [A Uniform Rewriting Algorithm for Twisted Tensor Representations of Finite General Linear Groups](https://arxiv.org/abs/2512.00263)
*Dang Vo Phuc*
...
### [241] [(Quasi-)admissible modules over symmetrizable Kac-Moody superalgebras](https://arxiv.org/abs/2512.00460)
...
### [242] [Representations of the Grassmann Poisson superalgebras](https://arxiv.org/abs/2512.00585)
...
### [243] [Symmetric subgroup schemes](https://arxiv.org/abs/2512.01398)
*Jinfeng Song*
...
### [244] [Multiplicity of characters of finite reductive groups and Drinfeld doubles](https://arxiv.org/abs/2512.01432)
*GyeongHyeon Nam*
...
### [245] [Lifting free modules to generalized Weyl algebras](https://arxiv.org/abs/2512.01520)
...
### [246] [Non-crossing partitions for exceptional hereditary curves](https://arxiv.org/abs/2512.01729)
...
### [247] [Non-archimedean Infinite Hecke Algebra](https://arxiv.org/abs/2512.01835)
