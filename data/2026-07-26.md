...
### [1] [Trust by Context, Not by Design? A Quantitative Study of Data Donation Willingness for Open-Source Civic AI in Switzerland](https://arxiv.org/abs/2607.21044)
...
### [2] [Risk-Limiting Audits for Parliamentary Majorities](https://arxiv.org/abs/2607.21082)
...
### [3] [Enhancing Gender Equality Assessment through Object-Oriented Bayesian networks: the European Gender Equality Index Case](https://arxiv.org/abs/2607.21114)
...
### [5] [Protected corners and a trichotomy for Han's conjecture](https://arxiv.org/abs/2607.20849)
*Marco Armenta*
...
### [6] [Closed formulas for energy functions on tensor squares of higher-level perfect crystals in classical affine types](https://arxiv.org/abs/2607.20934)
*Shaolong Han*
...
### [7] [A problem on sumset sizes of sets of lattice points](https://arxiv.org/abs/2607.20571)
*Melvyn B. Nathanson*
...
### [8] [Infinite Sidon-type sets for zero-sum linear forms](https://arxiv.org/abs/2607.20753)
*Christian Táfula*
...
### [9] [Inverses of Fibonacci and Lucas Numbers via Rational Indices](https://arxiv.org/abs/2607.20754)
...
### [10] [Zeros of the Dirichlet series of even zeta values](https://arxiv.org/abs/2607.20758)
*William D. Banks*
...
### [11] [On a Diophantine Equation with Jacobsthal and Fibonacci Numbers](https://arxiv.org/abs/2607.20763)
...
### [12] [Murmurations of quadratic Hecke $L$-functions of the Gaussian field](https://arxiv.org/abs/2607.20853)
...
### [13] [On $v_2(q),v_3(q),v_4(q)$, and Andrews' Conjectures 5 and 6](https://arxiv.org/abs/2607.20858)
*Jayashree Kalita*
...
### [14] [On structured cosine sums and applications](https://arxiv.org/abs/2607.20907)
*Qin Xue*
...
### [15] [Fibonacci, Dirichlet, and Gauss in a single sum](https://arxiv.org/abs/2607.20960)
*Benoit Cloitre*
...
### [16] [The $p$-rationality of $\mathbb{Q}\left(\sqrt{-(kp+m)}\right)$ and $\mathbb{Q}\left(\sqrt{p(p+1)}\right)$](https://arxiv.org/abs/2607.21250)
*Chen Lin,Xuejun Guo*
...
### [17] [On the Fractional Parts of Polynomials Modulo $p$](https://arxiv.org/abs/2607.21259)
...
### [18] [Zeta functions of $\mathrm{PGL}_n$ over non-Archimedean local fields](https://arxiv.org/abs/2607.21262)
...
### [19] [A Weighted Sum Formula for Double Eisenstein Series](https://arxiv.org/abs/2607.21358)
*Henrik Bachmann*
...
### [20] [Statistical properties of Hecke correspondences](https://arxiv.org/abs/2607.21505)
...
### [21] [Simultaneous non-vanishing of Dirichlet $L$--functions, II: Weighted central limit theorem](https://arxiv.org/abs/2607.21532)
...
### [22] [Analyzing \b{eta}-Lactamase Evolution from the Principle of Least Action Perspective](https://arxiv.org/abs/2607.20744)
...
### [23] [Evolutionary Le Chatelier's Principle: Phenotypic Plasticity and Genetic Assimilation via Timescale Separation in the Price Equation](https://arxiv.org/abs/2607.20915)
...
### [24] [Semi-analytical Light Curve Model for Transients Preceding Binary Mergers. I: Supernova Precursor Emission from Compact Object Companions](https://arxiv.org/abs/2607.20599)
...
### [25] [Revealing the Structure and Magnetization of GRB Jets with ALMA Polarization Observations](https://arxiv.org/abs/2607.20604)
...
### [26] [The Origin of the Magnetic Flux Driving TDE Jets](https://arxiv.org/abs/2607.20615)
...
### [27] [Polarization of impulsive relativistic jets propagating in a stratified medium](https://arxiv.org/abs/2607.20618)
...
### [28] [Time-evolving Diagnostic of the Ionized Absorbers in NGC 4051. II. High-throughput Time-resolved Spectroscopy](https://arxiv.org/abs/2607.20621)
...
### [29] [Reaction-constrained composition \(g\)-modes in neutron stars with antikaon condensates, hyperons, and \(Δ(1232)\) resonances](https://arxiv.org/abs/2607.20693)
...
### [30] [Exploring Physics beyond the Standard Model from kHz-Gravitational-Wave Signals of Core-Collapse Supernovae](https://arxiv.org/abs/2607.20921)
...
### [31] [Relativistic Oblique Shocks at Finite Temperature: Detachment Angle, Shock Polars, and the Turning Parameter](https://arxiv.org/abs/2607.20978)
...
### [32] [The Extended Ultrahigh-energy Gamma-Ray Emission in the Vicinity of PSR J2238+5903](https://arxiv.org/abs/2607.21026)
...
### [33] [Spirited Away: Advective Loss of Cosmic Rays into the Milky Way's Circumgalactic Medium Explains the Large Magellanic Cloud's Low Gamma-ray Luminosity](https://arxiv.org/abs/2607.21316)
...
### [34] [Rapid Orbital Decay of Supersoft X-Ray Source WX Cen: a Surrounding Circumbinary Disk](https://arxiv.org/abs/2607.21364)
...
### [35] [Importance and Science Outcomes from the first XSPECT/XPoSat Workshop](https://arxiv.org/abs/2607.21365)
...
### [37] [XMM-Newton and Swift Unveil Another X-Ray Transient in NGC 4945, XMM J130514.64-493311.27](https://arxiv.org/abs/2607.21587)
...
### [38] [The rank-five Peterson hit problem, the fifth Singer transfer, and a geometric generator in unoriented cobordism](https://arxiv.org/abs/2607.20566)
*Dang Vo Phuc*
...
### [39] [Maximal topological complexity of monotone symplectic 4-manifolds](https://arxiv.org/abs/2607.20886)
*Ryuma Orita*
...
### [40] [Mixed Hodge formality](https://arxiv.org/abs/2607.21176)
*Pedro Magalhães*
...
### [41] [Discrete version of topological complexity of maps](https://arxiv.org/abs/2607.21330)
...
### [42] [On the integral algebraic K-theory of Morava K-theory](https://arxiv.org/abs/2607.21567)
...
### [43] [Monte Carlo Studies of Twisted Bilayer Graphene: Strain and Thermal Fluctuations](https://arxiv.org/abs/2607.20619)
...
### [44] [Colloquium: Semi-Dirac Fermions in Quantum Matter](https://arxiv.org/abs/2607.20627)
...
### [45] [Ferromagnetic transition in a chiral spin chain](https://arxiv.org/abs/2607.20629)
...
### [46] [Doping-induced Ferromagnetic order and its unusual evolution to Helical Antiferromagnetic Order in Sr(Ni$_{1-x}$Co$_x$)$_2$P$_2$](https://arxiv.org/abs/2607.20663)
...
### [47] [Exact Nagaoka-to-spiral transition in the doped infinite-U triangular lattice](https://arxiv.org/abs/2607.20726)
...
### [48] [Gaplessness indicator by topologically trivial twisting operators](https://arxiv.org/abs/2607.20944)
...
### [49] [Thermal Hall Resistivity as a Unifying Description of Phonon Thermal Hall Effect in Various Insulators](https://arxiv.org/abs/2607.21157)
...
### [50] [Long-wavelength density response and momentum resolution in strange-metal charge spectroscopy](https://arxiv.org/abs/2607.21206)
*Ilmo Sung*
...
### [51] [Shiba duality and $η$-altermagnetism: Pairing and charge orders in bipartite attractive Hubbard models](https://arxiv.org/abs/2607.21430)
*Yu-Ping Lin*
...
### [52] [Interlayer interactions reshape charge-density wave through electronic elasticity in 4H$_{\mathrm{b}}$-TaS$_2$](https://arxiv.org/abs/2607.21470)
...
### [53] [Pseudogap formation in the moderate correlated layered attractive Hubbard model](https://arxiv.org/abs/2607.21478)
...
### [54] [Strong correlations and local self-energies from on-site ensembles](https://arxiv.org/abs/2607.21490)
...
### [55] [Symmetry and Quantum Geometry in Bloch Bands](https://arxiv.org/abs/2607.21581)
...
### [56] [An FBSDE Construction of the Sine-Gordon EQFT for $β^{2} < \frac{6}{7}\, 8π$ and Perturbative Renormalization in the Full Subcritical Regime](https://arxiv.org/abs/2607.20632)
*Sarah-Jean Meyer*
...
### [57] [Affine Extension of the Free-Particle--Oscillator--Inverted-Oscillator Triangle](https://arxiv.org/abs/2607.20711)
...
### [58] [High-resolution decomposition of canonical Hamiltonian systems](https://arxiv.org/abs/2607.20740)
...
### [59] [An Operator-Algebraic Exposition of the Thirring-Wehrl Theory of the Quasi-Spin BCS Model](https://arxiv.org/abs/2607.21158)
*Yoshitsugu Sekine*
...
### [60] [Continuum limit of discretized matrix-valued Fourier multipliers](https://arxiv.org/abs/2607.21177)
...
### [61] [Representation of the causal logic for the Dirac system and the electron](https://arxiv.org/abs/2607.21266)
...
### [62] [On Leray's Theoreme de Structure for a weak solution to the Navier-Stokes equations: an improvement of the result](https://arxiv.org/abs/2607.21380)
*Paolo Maremonti*
...
### [63] [Two-phase source and reaction coefficient Stefan type problems](https://arxiv.org/abs/2607.21388)
*Targyn A. Nauryz*
...
### [64] [HERMES: Heterogeneous Edge-Relational Multi-Head Embedded SSM Attention for Traffic Conflict Prediction at Signalized Intersections](https://arxiv.org/abs/2607.20505)
...
### [65] [PhysCoRe: Physics-Corrected Residual World Models for Material-Aware Deformable Dynamics](https://arxiv.org/abs/2607.20653)
...
### [66] [Scalable Low-Cost Laboratory Automation: A Digital Twin-Integrated Robotic Platform for Autonomous Liquid Handling (RAINBOTTM)](https://arxiv.org/abs/2607.20662)
...
### [67] [Safe and Scalable Multi-Drone Payload Transport via CBF-based Reinforcement Learning with Zero-Shot Sim-to-Real Transfer](https://arxiv.org/abs/2607.20665)
...
### [68] [Towards Capability-Aware Traversability Navigation for Unstructured Environments](https://arxiv.org/abs/2607.20679)
...
### [69] [FELT: Generating Tactile Signals from Vision for Visuo-Tactile Manipulation](https://arxiv.org/abs/2607.20683)
...
### [70] [Decentralized UAV Swarms for Ground Target Protection in GPS- and Communication-Denied Environments](https://arxiv.org/abs/2607.20710)
...
### [71] [Self-Supervised Bio-Inspired Robotic Trajectory Planning with Obstacle Avoidance](https://arxiv.org/abs/2607.20743)
...
### [72] [A real-time RGB-D perception pipeline for autonomous impact hammers in mining: self-filtering, rock segmentation and rock-breaking poses generation](https://arxiv.org/abs/2607.20748)
...
### [73] [Emergent Compositional Skills in Mixture-of-Experts VLAs](https://arxiv.org/abs/2607.20771)
...
### [74] [Socially Consistent Multi-Robot Navigation Using Decoupled Planning and Trajectory Coordination](https://arxiv.org/abs/2607.20772)
...
### [75] [Robostral Navigate](https://arxiv.org/abs/2607.20785)
...
### [76] [URF: A Unified Robot Control-Policy Framework for Stable Contact Aware Manipulation](https://arxiv.org/abs/2607.20912)
...
### [77] [Deep Reinforcement-Learning-Guided Model Predictive Control for Preventing Overtakes in Autonomous Racing](https://arxiv.org/abs/2607.20973)
...
### [78] [Distributed Model-Based Diffusion For Scalable Multi-Robot Trajectory Optimization](https://arxiv.org/abs/2607.20992)
...
### [79] [TableVerse: A Large-scale Tabletop Dataset with Real-world Grounded Layouts for Generalizable Manipulation](https://arxiv.org/abs/2607.21017)
...
### [80] [ZONDA: Zero-shot Object Navigation with Dynamic Avoidance in Multi-floor Environments](https://arxiv.org/abs/2607.21025)
...
### [81] [A Real-Time Generalized Nash Equilibrium Framework for Interaction-Aware Autonomous Driving in Mixed Traffic](https://arxiv.org/abs/2607.21043)
...
### [82] [GuidedAttention: Interpretable and Correctable Visual Attention for OOD-Robust Robot Manipulation via Imitation Learning](https://arxiv.org/abs/2607.21049)
...
### [83] [Human-Inspired Framework for Robotic Craniotomy: Integrating Multimodal Fusion and Adaptive Trajectory Adjustment](https://arxiv.org/abs/2607.21058)
...
### [84] [RL-MACRO: A Cybernetic Closed-Loop Intelligence Framework for Multimodal Adaptive Robotic Craniotomy](https://arxiv.org/abs/2607.21113)
...
### [85] [FORGE-plus: Force-Budgeted Recovery for Contact-Rich Assembly with a Frozen LLM Supervisor](https://arxiv.org/abs/2607.21227)
...
### [86] [Factorized Spatio-Temporal Convolutions for Human Pose Estimation from Planar Lidar](https://arxiv.org/abs/2607.21309)
...
### [87] [Grasp, Handover, Rotate: Bimanual Object Reorientation via Compositional Diffusion and Energy-Based Optimization](https://arxiv.org/abs/2607.21341)
...
### [88] [VoLN: Vision-Only Long-Horizon Navigation---Paradigm, Benchmark, and Method](https://arxiv.org/abs/2607.21400)
...
### [89] [GLAM-SLAM: Real-time Gaussian Large-scale Mapping via Flow Densification and Spatial Decomposition](https://arxiv.org/abs/2607.21416)
...
### [90] [GS-Agent: Creating 4D Physical Worlds With Generative Simulation](https://arxiv.org/abs/2607.21522)
...
### [91] [Beyond Episodic Evaluation: Memory Architectural Bottlenecks in Sequential Embodied Question Answering](https://arxiv.org/abs/2607.21571)
...
### [92] [Scale Up Strategically: Learning Compositional Generalization via Bias-Aware Evaluation and Data Collection for Robotic Manipulation](https://arxiv.org/abs/2607.21582)
...
### [93] [AXIS: A Growable Community-Driven Data Engine for Scalable Robot Manipulation](https://arxiv.org/abs/2607.21588)
...
### [94] [Beyond Degree Four: Near-Orthogonal Planar Drawings](https://arxiv.org/abs/2607.21305)
...
### [95] [Solar axion searches with RES-NOVA: projected sensitivity and first prototype limit](https://arxiv.org/abs/2607.21363)
...
### [96] [A converged architecture for processing 32 Tbps of physics data in real-time at the LHCb experiment](https://arxiv.org/abs/2607.21492)
...
### [97] [Measurements of the electroweak production of a $W$ boson in association with two jets at $\sqrt{s}=13\,\mathrm{TeV}$ with the ATLAS detector](https://arxiv.org/abs/2607.21531)
*ATLAS Collaboration*
...
### [98] [First-Order Analysis of Optimization in Uniformly Convex Metric Spaces: Directional Subderivatives and Basic Descent](https://arxiv.org/abs/2607.20677)
...
### [99] [Rule-Induced Behavior of Fuzzy Scalar Objective Functions for Reliable Multi-Criteria Decision Making](https://arxiv.org/abs/2607.20731)
*Olaf Frommann*
...
### [100] [A Safeguarded Projected-Gradient Framework for Complementarity-Constrained Least-Squares Problems](https://arxiv.org/abs/2607.20786)
...
### [101] [Mean field and N-agent games for optimal relative consumption-investment with jump risk and common noise](https://arxiv.org/abs/2607.20845)
...
### [102] [Structure-Preserving Spectral Dynamic Programming on Compact Lie Groups](https://arxiv.org/abs/2607.20854)
...
### [103] [Implicit Primal-Dual Guarantees in Unconstrained First-Order Minimization](https://arxiv.org/abs/2607.20875)
...
### [104] [Learning to recover: Adaptive local branching with reinforcement learning for log-truck routing and scheduling under disruptions](https://arxiv.org/abs/2607.20901)
...
### [105] [Boundary control and periodic trajectories of semilinear Euler equations with application to hydrogen transport](https://arxiv.org/abs/2607.20948)
...
### [106] [Dynamic Cloud Service-Capacity Deployment with Costly Response Readiness](https://arxiv.org/abs/2607.20961)
...
### [107] [Control Co-design of systems with parabolic PDE dynamics](https://arxiv.org/abs/2607.20975)
...
### [108] [Stabilization of 1D Linear Hyperbolic Balance Laws by Integral Difference Control and Application to Networks Stabilization](https://arxiv.org/abs/2607.21060)
...
### [109] [Exact ensemble controllability for neural differential equations via neural interpolation](https://arxiv.org/abs/2607.21112)
*Martin Gugat*
...
### [110] [A Gaussian smoothing-based zeroth-order method for Goldstein second-order stationarity](https://arxiv.org/abs/2607.21258)
...
### [111] [Fokker-Planck-Kolmogorov inclusions of the mean field type](https://arxiv.org/abs/2607.21297)
*Yurii Averboukh*
...
### [112] [Decomposing a Multi-Scale Optimization Framework for Grid-Integrated Electrolysis using Aggregate-Informed Benders](https://arxiv.org/abs/2607.21440)
...
### [113] [Climate-resilient electric vehicle charging infrastructure for sustainable cities: An interpretable causal-ensemble framework for preventive maintenance and low-carbon mobility](https://arxiv.org/abs/2607.21444)
...
### [114] [Asymptotic Analysis of Empirical Dynamic Programming in Infinite-Horizon Stochastic Optimal Control](https://arxiv.org/abs/2607.21520)
...
### [115] [Barzilai-Borwein Fails Superlinear Convergence on an Open Set of Quadratics for Every Dimension $n\geq 4$](https://arxiv.org/abs/2607.21579)
...
### [116] [Convergence and mixed-precision preconditioning for the naive Jacobi eigenvalue algorithm](https://arxiv.org/abs/2607.20749)
...
### [117] [A virtual element method for Darcy's problem coupled with a heat equation](https://arxiv.org/abs/2607.20755)
...
### [118] [Hierarchical Log-Gaussian Relaxation on a Fixed D3Q125 Velocity Set](https://arxiv.org/abs/2607.20846)
*Bjørn Wu*
...
### [119] [High-Order Exponential Integrators with Improved Uniform Accuracy for Charged-Particle in a Perpendicular Strong Magnetic Field](https://arxiv.org/abs/2607.21096)
...
### [120] [A stability-preserving polytopal discontinuous Galerkin method for the Fisher-Kolmogorov model with applications to neurodegenerative diseases](https://arxiv.org/abs/2607.21108)
...
### [121] [A Damped SWIFT Method for European Option Pricing: Coefficients Decay, Truncation, and Error Analysis](https://arxiv.org/abs/2607.21109)
...
### [122] [A Mixed Discrete Cosserat Rod Formulation](https://arxiv.org/abs/2607.21164)
...
### [123] [A Hyper-Reduced Neural Network-Augmented Semi-smooth Newton Method for Nonlinear Parametric Variational Inequalities](https://arxiv.org/abs/2607.21242)
...
### [124] [Adaptive Non-Linear Partition of Unity Methods for Scattered Data Interpolation with Discontinuities](https://arxiv.org/abs/2607.21287)
...
### [125] [On the Approximation of the Unitary Operator Group Associated with a Rotation Matrix and Its Applications to Abstract Hyperbolic Equations](https://arxiv.org/abs/2607.21293)
...
### [126] [An unfitted boundary algebraic equation method with Calderón preconditioning for 2D Stokes flow in irregular geometry](https://arxiv.org/abs/2607.21295)
...
### [127] [3D Uncertainty Quantification for the Photo-Acoustic Tomography](https://arxiv.org/abs/2607.21373)
...
### [128] [Jordan algebras, hemiplex numbers, and the Cholesky decomposition of arbitrary symmetric matrices](https://arxiv.org/abs/2607.21383)
