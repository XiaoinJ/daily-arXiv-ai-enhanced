...
### [38] [Socio-demographic inequalities in the maximum human lifespan](https://arxiv.org/abs/2604.07974)
...
### [39] [Quantifying Decarbonization Speed Across Climate Scenarios](https://arxiv.org/abs/2604.08049)
*Fangyuan Zhang*
...
### [40] [WaST: a formalisation of the Wave model with associated statistical inference and applications](https://arxiv.org/abs/2604.08220)
*Grégoire Clarté*
...
### [41] [The Schwarz function and the shrinking of the Szegő curve: electrostatic, hydrodynamic, and random matrix models](https://arxiv.org/abs/2604.07832)
...
### [42] [A unified 4D phase-space framework for two-level quantum dynamics: open-source library](https://arxiv.org/abs/2604.07865)
*O. Morandi*
...
### [43] [Scalar Truesdell Time Derivative and $(L^{2},H^{-1})$ - Surface Gradient Flows](https://arxiv.org/abs/2604.08186)
...
### [44] [Interpolation and approximation of piecewise smooth functions with corner discontinuities on sigma quasi-uniform grids](https://arxiv.org/abs/2604.07534)
...
### [45] [Universal, sample-optimal algorithms for recovery of anisotropic functions from i.i.d. samples](https://arxiv.org/abs/2604.07660)
...
### [46] [Error Analysis of a Conforming FEM for Multidimensional Fragmentation Equations](https://arxiv.org/abs/2604.07793)
*Arushi,Naresh Kumar*
...
### [47] [A Multilevel Monte Carlo Virtual Element Method for Uncertainty Quantification of Elliptic Partial Differential Equations](https://arxiv.org/abs/2604.08135)
...
### [48] [Five-Structures Preserving Algorithm for charge dynamics model](https://arxiv.org/abs/2604.08228)
...
### [49] [Local discontinuous Galerkin FEM for convex minimization](https://arxiv.org/abs/2604.08246)
...
### [50] [Meshfree GMsFEM-based exponential integration for multiscale 3D advection-diffusion problems](https://arxiv.org/abs/2604.08347)
...
### [51] [Hard-constrained Physics-informed Neural Networks for Interface Problems](https://arxiv.org/abs/2604.08453)
...
### [52] [K$_2$Co$_2$(TeO$_{3}$)$_{3}$ $\cdot$ 2.5 H$_2$O : A mineral-inspired pseudo-honeycomb cobalt dimer antiferromagnet](https://arxiv.org/abs/2604.07376)
...
### [53] [d-Wave pair density wave superconductivity in a two-orbital model](https://arxiv.org/abs/2604.07511)
...
### [54] [Fortuitous Universality of Bose-Kondo Impurities](https://arxiv.org/abs/2604.07554)
...
### [55] [Directional Criticality and Higher-Order Flatness: Designing Van Hove Singularities in Three Dimensions](https://arxiv.org/abs/2604.07806)
...
### [56] [Fluctuation Mechanism of Single-Ion Anisotropy of Topological Insulator MnBi$_2$Te$_4$](https://arxiv.org/abs/2604.07852)
...
### [57] [Hubbard vs. Emery model: spectra, transport and relevance for cuprates](https://arxiv.org/abs/2604.08085)
...
### [58] [Co-operating multiorbital and nonlocal correlations in bilayer nickelate](https://arxiv.org/abs/2604.08221)
...
### [59] [Orbital-Selective $d$-wave Superconductivity in the Two-Band $t$-$J$ Model: Possible Applications to La$_3$Ni$_2$O$_7$](https://arxiv.org/abs/2604.08319)
...
### [60] [Revealing the nature of the charge density wave order of ErTe$_3$ via Raman scattering under anisotropic strain](https://arxiv.org/abs/2604.08440)
...
### [61] [L-fuzzy simplicial homology](https://arxiv.org/abs/2604.08166)
...
### [62] [Lifting banal representations of classical groups](https://arxiv.org/abs/2604.07516)
*Johannes Droschl*
...
### [63] [L-modules are mixed](https://arxiv.org/abs/2604.07719)
*Leslie Saper*
...
### [64] [On Lower Bounds for sums of Fourier Coefficients of Twist-Inequivalent Newforms](https://arxiv.org/abs/2604.07474)
...
### [65] [Universal sums of generalized polygonal numbers of almost prime length](https://arxiv.org/abs/2604.07826)
...
### [66] [Proofs for Andrews' Conjectures 5 and 6 on $v_1(q)$](https://arxiv.org/abs/2604.08013)
...
### [67] [A Liouville-Type Inequality for Values of Mahler M-Functions](https://arxiv.org/abs/2604.08208)
...
### [85] [Development of Faster and More Accurate Supernova Localization at Super-Kamiokande](https://arxiv.org/abs/2604.07702)
...
### [86] [GW190711_030756 and GW200114_020818: astrophysical interpretation of two asymmetric binary black hole mergers in the IAS catalog](https://arxiv.org/abs/2604.07388)
...
### [87] [Detection and Evolution of Linear Polarization of the Galactic Center Transient MAXI J1744-294](https://arxiv.org/abs/2604.07431)
...
### [88] [From Internal Collision to Photon Escape: First-Principles Modeling of Radiation-Mediated Shocks in Gamma-Ray Burst Photospheres](https://arxiv.org/abs/2604.07453)
...
### [89] [Second-Generation Mass Peak in the Gravitational-Wave Population as a Probe of Globular Clusters](https://arxiv.org/abs/2604.07456)
...
### [90] [Which Neutron Stars Reach the Stiffening Regime? Multimessenger Constraints on Core Sound Speed and Stellar-Mass Thresholds](https://arxiv.org/abs/2604.07542)
...
### [91] [Detection of TeV emission during early afterglow from poorly localized GRBs with ground based IACTs](https://arxiv.org/abs/2604.07582)
...
### [92] [Isolating Sgr A East: The First Uncontaminated X-ray Maps of a Galactic Center Supernova Remnant](https://arxiv.org/abs/2604.07588)
...
### [93] [Resolving the 2024 Outburst of Magnetar 1E 1841-045 from its host Supernova Remnant with EP-FXT](https://arxiv.org/abs/2604.07734)
...
### [94] [A study of periodic nulling in PSR B0751+32 with FAST](https://arxiv.org/abs/2604.07742)
...
### [95] [Does the spectral break in the IceCube diffuse neutrino spectrum originate from AGN evolution?](https://arxiv.org/abs/2604.07824)
...
### [96] [The deci-Hz gravitational wave signal from the collapse of rotating very massive stars](https://arxiv.org/abs/2604.07878)
...
### [97] [Oblique Shocks at Supernova Remnants in Massive Star Clusters: A Model for the Cosmic-Ray Knee Observed by LHAASO](https://arxiv.org/abs/2604.07977)
...
### [98] [Flux variability of the "10 keV feature" of 4U 0115+63](https://arxiv.org/abs/2604.08051)
...
### [99] [How many VHE gamma-ray binaries with young pulsars can be observed?](https://arxiv.org/abs/2604.08175)
...
### [100] [The Stack Search Tests on FAST Data: Discovery of Six Faint Isolated Millisecond Pulsars in NGC 6517 and NGC 7078 (M15)](https://arxiv.org/abs/2604.08268)
...
### [101] [Stochastic problems in pulsar timing](https://arxiv.org/abs/2604.08373)
...
### [102] [A parametric study of plasma instability cooling and its impact on intergalactic magnetic field constraints in GeV cascades](https://arxiv.org/abs/2604.08375)
...
### [103] [Optical images of Kerr-Sen black hole illuminated by thick accretion disks](https://arxiv.org/abs/2604.08439)
...
### [104] [Multiplicity dependence of prompt and non-prompt J/$ψ$ production at midrapidity in pp collisions at $\sqrt{s} = 13$ TeV](https://arxiv.org/abs/2604.07968)
*ALICE Collaboration*
...
### [105] [Recent Neutrino Oscillation and Cross-Section Results from the T2K Experiment](https://arxiv.org/abs/2604.08259)
*Nick Latham*
...
### [106] [Search for the lepton-flavour violating decays $B^+ \to π^+ μ^\pm e^\mp$](https://arxiv.org/abs/2604.08396)
